...
declare module '@polkadot/api-base/types/errors' {
  interface AugmentedErrors<ApiType extends ApiTypes> {
    ...
    teebag: {
       ...
       **/
      AuthorizedEnclaveAlreadyExist: AugmentedError<ApiType>;
      /**
       * The authorized enclave doesn't exist.
       **/
      AuthorizedEnclaveNotExist: AugmentedError<ApiType>;
      /**
       ...
       **/
      EnclaveNotAuthorized: AugmentedError<ApiType>;
      /**
       ...
       **/
      MaxAuthorizedEnclaveOverflow: AugmentedError<ApiType>;
      /**

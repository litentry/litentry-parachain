...
import type { DiscordOAuth2, DiscordValidationData, IdentityContext, IdentityGenericEvent, IdentityStatus, LitentryIdentity, LitentryMultiSignature, LitentryValidationData, PublicMessage, PublicTweet, TwitterOAuth2, TwitterValidationData, Web2ValidationData, Web3CommonValidationData, Web3Network, Web3ValidationData } from './identityManagement';
import type { AesKey, DirectRequestStatus, EncryptedAesRequest, ErrorDetail, Getter, KeyAesOutput, LinkIdentityResult, PublicGetter, Request, RequestVCResult, RequestVcErrorDetail, RequestVcResultOrError, SetIdentityNetworksResult, ShardIdentifier, StfError, TrustedCall, TrustedCallSigned, TrustedGetter, TrustedGetterSigned, TrustedOperation, TrustedOperationStatus, VCMPError, WorkerRpcReturnValue } from './trustedCalls';
...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    EncryptedAesRequest: EncryptedAesRequest;
    Epoch: Epoch;
    ...
    Request: Request;
    RequestVcErrorDetail: RequestVcErrorDetail;

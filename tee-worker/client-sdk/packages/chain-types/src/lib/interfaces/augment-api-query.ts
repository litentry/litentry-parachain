...
import type { CorePrimitivesIdentity, CumulusPalletDmpQueueConfigData, CumulusPalletDmpQueuePageIndexData, CumulusPalletParachainSystemCodeUpgradeAuthorization, CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot, CumulusPalletXcmpQueueInboundChannelDetails, CumulusPalletXcmpQueueOutboundChannelDetails, CumulusPalletXcmpQueueQueueConfigData, EthereumBlock, EthereumReceiptReceiptV3, EthereumTransactionTransactionV2, FpRpcTransactionStatus, FrameSupportDispatchPerDispatchClassWeight, FrameSupportPreimagesBounded, FrameSystemAccountInfo, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, OrmlTokensAccountData, OrmlTokensBalanceLock, OrmlTokensReserveData, PalletAssetManagerAssetMetadata, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesIdAmount, PalletBalancesReserveData, PalletBitacrossCustodialWallet, PalletBitacrossMimicCustodialTypeBtcToEth, PalletBitacrossMimicCustodialTypeEthToBtc, PalletBountiesBounty, PalletBridgeBridgeEvent, PalletBridgeProposalVotes, PalletCollectiveVotes, PalletDemocracyMetadataOwner, PalletDemocracyReferendumInfo, PalletDemocracyVoteThreshold, PalletDemocracyVoteVoting, PalletEvmAssertionsAssertion, PalletEvmCodeMetadata, PalletExtrinsicFilterOperationalMode, PalletIdentityRegistrarInfo, PalletIdentityRegistration, PalletMultisigMultisig, PalletParachainStakingAutoCompoundAutoCompoundConfig, PalletParachainStakingBond, PalletParachainStakingCandidateMetadata, PalletParachainStakingCollatorSnapshot, PalletParachainStakingDelayedPayout, PalletParachainStakingDelegationRequestsScheduledRequest, PalletParachainStakingDelegations, PalletParachainStakingDelegator, PalletParachainStakingInflationInflationInfo, PalletParachainStakingParachainBondConfig, PalletParachainStakingRoundInfo, PalletParachainStakingSetOrderedSet, PalletPreimageRequestStatus, PalletProxyAnnouncement, PalletProxyProxyDefinition, PalletSchedulerScheduled, PalletTeebagEnclave, PalletTeebagOperationalMode, PalletTeebagQuotingEnclave, PalletTeebagSidechainBlockConfirmation, PalletTeebagTcbTcbInfoOnChain, PalletTeebagWorkerType, PalletTipsOpenTip, PalletTransactionPaymentReleases, PalletTreasuryProposal, PalletVcManagementSchemaVcSchema, PalletVestingReleases, PalletVestingVestingInfo, PalletXcmQueryStatus, PalletXcmRemoteLockedFungibleRecord, PalletXcmVersionMigrationStage, PolkadotCorePrimitivesOutboundHrmpMessage, PolkadotPrimitivesV4AbridgedHostConfiguration, PolkadotPrimitivesV4PersistedValidationData, PolkadotPrimitivesV4UpgradeRestriction, RococoParachainRuntimeSessionKeys, RuntimeCommonXcmImplCurrencyId, SpConsensusAuraSr25519AppSr25519Public, SpCoreCryptoKeyTypeId, SpRuntimeDigest, SpTrieStorageProof, SpWeightsWeightV2Weight, XcmVersionedAssetId, XcmVersionedMultiLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      assetIdMetadata: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletAssetManagerAssetMetadata>>, [u128]>;
      /**
       * Mapping from an asset id to asset type.
       * This is mostly used when receiving transaction specifying an asset directly,
       * like transferring an asset from this chain to another.
       **/
      assetIdType: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<RuntimeCommonXcmImplCurrencyId>>, [u128]>;
      /**
       ...
       **/
      assetTypeId: AugmentedQuery<ApiType, (arg: RuntimeCommonXcmImplCurrencyId | { SelfReserve: any } | { ParachainReserve: any } | string | Uint8Array) => Observable<Option<u128>>, [RuntimeCommonXcmImplCurrencyId]>;
      /**
    ...
    bitacross: {
      ...
      relayer: AugmentedQuery<ApiType, (arg: CorePrimitivesIdentity | { Twitter: any } | { Discord: any } | { Github: any } | { Substrate: any } | { Evm: any } | { Bitcoin: any } | { Solana: any } | string | Uint8Array) => Observable<Option<Null>>, [CorePrimitivesIdentity]>;
      vault: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<PalletBitacrossCustodialWallet>, [AccountId32]>;
    };
    bitacrossMimic: {
      mimicBtcToEthStorage: AugmentedQuery<ApiType, (arg1: U8aFixed | string | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Option<PalletBitacrossMimicCustodialTypeBtcToEth>>, [U8aFixed, u64]>;
      mimicEthToBtcStorage: AugmentedQuery<ApiType, (arg1: H160 | string | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Option<PalletBitacrossMimicCustodialTypeEthToBtc>>, [H160, u64]>;
    };
    bounties: {
      /**
    ...
    bridgeTransfer: {
      bridgeBalances: AugmentedQuery<ApiType, (arg1: U8aFixed | string | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<Option<u128>>, [U8aFixed, AccountId32]>;
    ...
    chainBridge: {
      ...
      votes: AugmentedQuery<ApiType, (arg1: u8 | AnyNumber | Uint8Array, arg2: ITuple<[u64, Call]> | [u64 | AnyNumber | Uint8Array, Call | IMethod | string | Uint8Array]) => Observable<Option<PalletBridgeProposalVotes>>, [u8, ITuple<[u64, Call]>]>;
    };
    council: {
      /**
    ...
    evmAssertions: {
       ...
       **/
      assertions: AugmentedQuery<ApiType, (arg: H160 | string | Uint8Array) => Observable<Option<PalletEvmAssertionsAssertion>>, [H160]>;
    };
    extrinsicFilter: {
      /**
       ...
       * blocked
       **/
      blockedExtrinsics: AugmentedQuery<ApiType, (arg: ITuple<[Bytes, Bytes]> | [Bytes | string | Uint8Array, Bytes | string | Uint8Array]) => Observable<Option<Null>>, [ITuple<[Bytes, Bytes]>]>;
      /**
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<RococoParachainRuntimeSessionKeys>>, [AccountId32]>;
      /**
    ...
    teebag: {
      ...
      authorizedEnclave: AugmentedQuery<ApiType, (arg: PalletTeebagWorkerType | 'Identity' | 'BitAcross' | number | Uint8Array) => Observable<Vec<U8aFixed>>, [PalletTeebagWorkerType]>;
      enclaveIdentifier: AugmentedQuery<ApiType, (arg: PalletTeebagWorkerType | 'Identity' | 'BitAcross' | number | Uint8Array) => Observable<Vec<AccountId32>>, [PalletTeebagWorkerType]>;
      enclaveRegistry: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletTeebagEnclave>>, [AccountId32]>;
      latestSidechainBlockConfirmation: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<PalletTeebagSidechainBlockConfirmation>, [H256]>;
      ...
      scheduledEnclave: AugmentedQuery<ApiType, (arg: ITuple<[PalletTeebagWorkerType, u64]> | [PalletTeebagWorkerType | 'Identity' | 'BitAcross' | number | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<Option<U8aFixed>>, [ITuple<[PalletTeebagWorkerType, u64]>]>;
      sidechainBlockFinalizationCandidate: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<u64>, [H256]>;
      tcbInfo: AugmentedQuery<ApiType, (arg: U8aFixed | string | Uint8Array) => Observable<PalletTeebagTcbTcbInfoOnChain>, [U8aFixed]>;
    };
    timestamp: {
      /**
    ...
    tokens: {
       ...
       * balances.
       **/
      accounts: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: u128 | AnyNumber | Uint8Array) => Observable<OrmlTokensAccountData>, [AccountId32, u128]>;
      /**
       * Any liquidity locks of a token type under an account.
       * NOTE: Should only be accessed when setting, changing and freeing a lock.
       **/
      locks: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: u128 | AnyNumber | Uint8Array) => Observable<Vec<OrmlTokensBalanceLock>>, [AccountId32, u128]>;
      /**
       * Named reserves on some account balances.
       **/
      reserves: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: u128 | AnyNumber | Uint8Array) => Observable<Vec<OrmlTokensReserveData>>, [AccountId32, u128]>;
      /**
    ...
    vcManagement: {
      admin: AugmentedQuery<ApiType, () => Observable<Option<AccountId32>>, []>;
      delegatee: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<Null>>, [AccountId32]>;
      schemaRegistry: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<PalletVcManagementSchemaVcSchema>>, [u64]>;

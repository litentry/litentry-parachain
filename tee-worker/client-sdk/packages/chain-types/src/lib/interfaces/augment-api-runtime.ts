...
import type { Bytes, Null, Option, Result, Vec } from '@polkadot/types-codec';
...
import type { AccountId, Block, H256, Header, Index, KeyTypeId, SlotDuration } from '@polkadot/types/interfaces/runtime';

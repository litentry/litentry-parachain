...
import type { CorePrimitivesAssertion, CorePrimitivesErrorImpError, CorePrimitivesErrorVcmpError, CorePrimitivesIdentity, CumulusPrimitivesParachainInherentParachainInherentData, EthereumTransactionTransactionV2, FrameSupportPreimagesBounded, PalletAssetManagerAssetMetadata, PalletBitacrossMimicCustodialTypeBtcToEth, PalletBitacrossMimicCustodialTypeEthToBtc, PalletDemocracyConviction, PalletDemocracyMetadataOwner, PalletDemocracyVoteAccountVote, PalletExtrinsicFilterOperationalMode, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletMultisigTimepoint, PalletTeebagAttestationType, PalletTeebagEnclave, PalletTeebagOperationalMode, PalletTeebagRsaRequest, PalletTeebagWorkerMode, PalletTeebagWorkerType, PalletVestingVestingInfo, RococoParachainRuntimeOriginCaller, RococoParachainRuntimeProxyType, RococoParachainRuntimeSessionKeys, RuntimeCommonXcmImplCurrencyId, SpCoreEd25519Public, SpWeightsWeightV2Weight, XcmV3MultiLocation, XcmV3WeightLimit, XcmVersionedMultiAsset, XcmVersionedMultiAssets, XcmVersionedMultiLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    accountFix: {
       ...
       **/
      setBalance: AugmentedSubmittable<(who: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, addFree: Compact<u128> | AnyNumber | Uint8Array, addReserved: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, Compact<u128>, Compact<u128>]>;
      /**
    ...
    assetManager: {
       ...
       **/
      addAssetType: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, newAssetType: RuntimeCommonXcmImplCurrencyId | { SelfReserve: any } | { ParachainReserve: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, RuntimeCommonXcmImplCurrencyId]>;
      /**
       ...
       **/
      registerForeignAssetType: AugmentedSubmittable<(assetType: RuntimeCommonXcmImplCurrencyId | { SelfReserve: any } | { ParachainReserve: any } | string | Uint8Array, metadata: PalletAssetManagerAssetMetadata | { name?: any; symbol?: any; decimals?: any; minimalBalance?: any; isFrozen?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [RuntimeCommonXcmImplCurrencyId, PalletAssetManagerAssetMetadata]>;
      /**
       ...
       **/
      removeAssetType: AugmentedSubmittable<(assetType: RuntimeCommonXcmImplCurrencyId | { SelfReserve: any } | { ParachainReserve: any } | string | Uint8Array, newDefaultAssetType: Option<RuntimeCommonXcmImplCurrencyId> | null | Uint8Array | RuntimeCommonXcmImplCurrencyId | { SelfReserve: any } | { ParachainReserve: any } | string) => SubmittableExtrinsic<ApiType>, [RuntimeCommonXcmImplCurrencyId, Option<RuntimeCommonXcmImplCurrencyId>]>;
      /**
       * Change the amount of units we are charging per execution second
       * for a given ForeignAssetType
       * 0 means not support
       **/
      setAssetUnitsPerSecond: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, unitsPerSecond: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, u128]>;
      updateForeignAssetMetadata: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, metadata: PalletAssetManagerAssetMetadata | { name?: any; symbol?: any; decimals?: any; minimalBalance?: any; isFrozen?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, PalletAssetManagerAssetMetadata]>;
    };
    balances: {
      /**
    ...
    bitacross: {
      addRelayer: AugmentedSubmittable<(account: CorePrimitivesIdentity | { Twitter: any } | { Discord: any } | { Github: any } | { Substrate: any } | { Evm: any } | { Bitcoin: any } | { Solana: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CorePrimitivesIdentity]>;
      /**
       * ---------------------------------------------------
      ...
      removeRelayer: AugmentedSubmittable<(account: CorePrimitivesIdentity | { Twitter: any } | { Discord: any } | { Github: any } | { Substrate: any } | { Evm: any } | { Bitcoin: any } | { Solana: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CorePrimitivesIdentity]>;
      /**
    ...
    bitacrossMimic: {
       ...
       * Weights should be 2 DB writes: 1 for mode and 1 for event
       **/
      writeBtcToEth: AugmentedSubmittable<(btcSender: U8aFixed | string | Uint8Array, data: PalletBitacrossMimicCustodialTypeBtcToEth | { txIndex?: any; btcTxHash?: any; ethereumReceiver?: any; ethereumTxHash?: any; ethTxStatus?: any; symbol?: any; amount?: any; txTimestamp?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [U8aFixed, PalletBitacrossMimicCustodialTypeBtcToEth]>;
      writeEthToBtc: AugmentedSubmittable<(ethSender: H160 | string | Uint8Array, data: PalletBitacrossMimicCustodialTypeEthToBtc | { txIndex?: any; btcTxHash?: any; btcReceiver?: any; btcReceiverLength?: any; ethereumTxHash?: any; ethTxStatus?: any; symbol?: any; amount?: any; txTimestamp?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H160, PalletBitacrossMimicCustodialTypeEthToBtc]>;
    };
    bounties: {
      /**
    ...
    bridgeTransfer: {
      setExternalBalances: AugmentedSubmittable<(externalBalances: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128]>;
      setMaximumIssuance: AugmentedSubmittable<(maximumIssuance: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128]>;
      /**
    ...
    chainBridge: {
       ...
       * # </weight>
       **/
      updateFee: AugmentedSubmittable<(destId: u8 | AnyNumber | Uint8Array, fee: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u8, u128]>;
      /**
    ...
    evmAssertions: {
      createAssertion: AugmentedSubmittable<(id: H160 | string | Uint8Array, byteCode: Bytes | string | Uint8Array, secrets: Vec<Bytes> | (Bytes | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [H160, Bytes, Vec<Bytes>]>;
    };
    extrinsicFilter: {
      /**
       ...
       **/
      blockExtrinsics: AugmentedSubmittable<(palletNameBytes: Bytes | string | Uint8Array, functionNameBytes: Option<Bytes> | null | Uint8Array | Bytes | string) => SubmittableExtrinsic<ApiType>, [Bytes, Option<Bytes>]>;
      /**
       * Set the mode
       * 
       ...
       * Weights should be 2 DB writes: 1 for mode and 1 for event
       **/
      setMode: AugmentedSubmittable<(mode: PalletExtrinsicFilterOperationalMode | 'Normal' | 'Safe' | 'Test' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletExtrinsicFilterOperationalMode]>;
      /**
       * unblock the given extrinsics
       * (pallet_name_bytes, function_name_bytes) can uniquely identify an extrinsic
       * if function_name_bytes is None, all extrinsics in `pallet_name_bytes` will be unblocked
       **/
      unblockExtrinsics: AugmentedSubmittable<(palletNameBytes: Bytes | string | Uint8Array, functionNameBytes: Option<Bytes> | null | Uint8Array | Bytes | string) => SubmittableExtrinsic<ApiType>, [Bytes, Option<Bytes>]>;
    };
    identityManagement: {
      /**
       * Activate an identity
       **/
      activateIdentity: AugmentedSubmittable<(shard: H256 | string | Uint8Array, encryptedIdentity: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, Bytes]>;
      /**
       * add an account to the delegatees
       **/
      addDelegatee: AugmentedSubmittable<(account: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      /**
       * Deactivate an identity
       **/
      deactivateIdentity: AugmentedSubmittable<(shard: H256 | string | Uint8Array, encryptedIdentity: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, Bytes]>;
      identityActivated: AugmentedSubmittable<(primeIdentity: CorePrimitivesIdentity | { Twitter: any } | { Discord: any } | { Github: any } | { Substrate: any } | { Evm: any } | { Bitcoin: any } | { Solana: any } | string | Uint8Array, idGraphHash: H256 | string | Uint8Array, reqExtHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CorePrimitivesIdentity, H256, H256]>;
       ...
       * ---------------------------------------------------
       **/
      identityLinked: AugmentedSubmittable<(primeIdentity: CorePrimitivesIdentity | { Twitter: any } | { Discord: any } | { Github: any } | { Substrate: any } | { Evm: any } | { Bitcoin: any } | { Solana: any } | string | Uint8Array, idGraphHash: H256 | string | Uint8Array, reqExtHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CorePrimitivesIdentity, H256, H256]>;
      identityNetworksSet: AugmentedSubmittable<(primeIdentity: CorePrimitivesIdentity | { Twitter: any } | { Discord: any } | { Github: any } | { Substrate: any } | { Evm: any } | { Bitcoin: any } | { Solana: any } | string | Uint8Array, idGraphHash: H256 | string | Uint8Array, reqExtHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CorePrimitivesIdentity, H256, H256]>;
      /**
       ...
       **/
      linkIdentity: AugmentedSubmittable<(shard: H256 | string | Uint8Array, user: AccountId32 | string | Uint8Array, encryptedIdentity: Bytes | string | Uint8Array, encryptedValidationData: Bytes | string | Uint8Array, encryptedWeb3networks: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, AccountId32, Bytes, Bytes, Bytes]>;
      /**
       * remove an account from the delegatees
       **/
      removeDelegatee: AugmentedSubmittable<(account: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      someError: AugmentedSubmittable<(primeIdentity: Option<CorePrimitivesIdentity> | null | Uint8Array | CorePrimitivesIdentity | { Twitter: any } | { Discord: any } | { Github: any } | { Substrate: any } | { Evm: any } | { Bitcoin: any } | { Solana: any } | string, error: CorePrimitivesErrorImpError | { LinkIdentityFailed: any } | { DeactivateIdentityFailed: any } | { ActivateIdentityFailed: any } | { UnclassifiedError: any } | string | Uint8Array, reqExtHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Option<CorePrimitivesIdentity>, CorePrimitivesErrorImpError, H256]>;
    };
    impExtrinsicWhitelist: {
       ...
       **/
      batchAddGroupMembers: AugmentedSubmittable<(vs: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Vec<AccountId32>]>;
      /**
       * Batch Removing existing group members
       **/
      batchRemoveGroupMembers: AugmentedSubmittable<(vs: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Vec<AccountId32>]>;
      /**
    ...
    parachainStaking: {
       ...
       **/
      addCandidatesWhitelist: AugmentedSubmittable<(candidate: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      /**
       ...
       **/
      delegate: AugmentedSubmittable<(candidate: AccountId32 | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, u128]>;
      /**
       * If caller is not a delegator and not a collator, then join the set of delegators
       * If caller is a delegator, then makes delegation to change their delegation state
       * Sets the auto-compound config for the delegation
       **/
      delegateWithAutoCompound: AugmentedSubmittable<(candidate: AccountId32 | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, autoCompound: Percent | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, u128, Percent]>;
      /**
       ...
       **/
      executeLeaveDelegators: AugmentedSubmittable<(delegator: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      /**
       ...
       * This function should be safe to delete after restriction removed
       **/
      removeCandidatesWhitelist: AugmentedSubmittable<(candidate: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      /**
       ...
       **/
      setAutoCompound: AugmentedSubmittable<(candidate: AccountId32 | string | Uint8Array, value: Percent | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, Percent]>;
      /**
    ...
    proxy: {
       ...
       **/
      createPure: AugmentedSubmittable<(proxyType: RococoParachainRuntimeProxyType | 'Any' | 'NonTransfer' | 'CancelProxy' | 'Collator' | 'Governance' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [RococoParachainRuntimeProxyType, u32, u16]>;
      /**
       ...
       **/
      killPure: AugmentedSubmittable<(spawner: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, proxyType: RococoParachainRuntimeProxyType | 'Any' | 'NonTransfer' | 'CancelProxy' | 'Collator' | 'Governance' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, height: Compact<u32> | AnyNumber | Uint8Array, extIndex: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, RococoParachainRuntimeProxyType, u16, Compact<u32>, Compact<u32>]>;
      /**
       ...
       **/
      proxy: AugmentedSubmittable<(real: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, forceProxyType: Option<RococoParachainRuntimeProxyType> | null | Uint8Array | RococoParachainRuntimeProxyType | 'Any' | 'NonTransfer' | 'CancelProxy' | 'Collator' | 'Governance' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, Option<RococoParachainRuntimeProxyType>, Call]>;
      /**
       ...
       * - `call`: The call to be made by the `real` account.
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, real: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, forceProxyType: Option<RococoParachainRuntimeProxyType> | null | Uint8Array | RococoParachainRuntimeProxyType | 'Any' | 'NonTransfer' | 'CancelProxy' | 'Collator' | 'Governance' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, MultiAddress, Option<RococoParachainRuntimeProxyType>, Call]>;
      /**
    ...
    session: {
       ...
       * fixed.
       **/
      setKeys: AugmentedSubmittable<(keys: RococoParachainRuntimeSessionKeys | { aura?: any } | string | Uint8Array, proof: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [RococoParachainRuntimeSessionKeys, Bytes]>;
    };
    sudo: {
      /**
    ...
    teebag: {
      forceAddAuthorizedEnclave: AugmentedSubmittable<(workerType: PalletTeebagWorkerType | 'Identity' | 'BitAcross' | number | Uint8Array, mrenclave: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletTeebagWorkerType, U8aFixed]>;
      forceAddEnclave: AugmentedSubmittable<(who: AccountId32 | string | Uint8Array, enclave: PalletTeebagEnclave | { workerType?: any; workerMode?: any; mrenclave?: any; lastSeenTimestamp?: any; url?: any; shieldingPubkey?: any; vcPubkey?: any; sgxBuildMode?: any; attestationType?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, PalletTeebagEnclave]>;
      forceRemoveAuthorizedEnclave: AugmentedSubmittable<(workerType: PalletTeebagWorkerType | 'Identity' | 'BitAcross' | number | Uint8Array, mrenclave: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletTeebagWorkerType, U8aFixed]>;
      forceRemoveEnclave: AugmentedSubmittable<(who: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      forceRemoveEnclaveByMrenclave: AugmentedSubmittable<(mrenclave: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [U8aFixed]>;
      forceRemoveEnclaveByWorkerType: AugmentedSubmittable<(workerType: PalletTeebagWorkerType | 'Identity' | 'BitAcross' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletTeebagWorkerType]>;
      parentchainBlockProcessed: AugmentedSubmittable<(blockHash: H256 | string | Uint8Array, blockNumber: u32 | AnyNumber | Uint8Array, taskMerkleRoot: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, u32, H256]>;
      postOpaqueTask: AugmentedSubmittable<(request: PalletTeebagRsaRequest | { shard?: any; payload?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletTeebagRsaRequest]>;
      registerEnclave: AugmentedSubmittable<(workerType: PalletTeebagWorkerType | 'Identity' | 'BitAcross' | number | Uint8Array, workerMode: PalletTeebagWorkerMode | 'OffChainWorker' | 'Sidechain' | number | Uint8Array, attestation: Bytes | string | Uint8Array, workerUrl: Bytes | string | Uint8Array, shieldingPubkey: Option<Bytes> | null | Uint8Array | Bytes | string, vcPubkey: Option<SpCoreEd25519Public> | null | Uint8Array | SpCoreEd25519Public | string, attestationType: PalletTeebagAttestationType | { Ignore: any } | { Ias: any } | { Dcap: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletTeebagWorkerType, PalletTeebagWorkerMode, Bytes, Bytes, Option<Bytes>, Option<SpCoreEd25519Public>, PalletTeebagAttestationType]>;
      registerQuotingEnclave: AugmentedSubmittable<(enclaveIdentity: Bytes | string | Uint8Array, signature: Bytes | string | Uint8Array, certificateChain: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, Bytes, Bytes]>;
      registerTcbInfo: AugmentedSubmittable<(tcbInfo: Bytes | string | Uint8Array, signature: Bytes | string | Uint8Array, certificateChain: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, Bytes, Bytes]>;
      /**
       * Set the admin account
       * 
       * Weights should be 2 DB writes: 1 for mode and 1 for event
       ...
       * Weights should be 2 DB writes: 1 for mode and 1 for event
       **/
      setMode: AugmentedSubmittable<(newMode: PalletTeebagOperationalMode | 'Production' | 'Development' | 'Maintenance' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletTeebagOperationalMode]>;
      sidechainBlockImported: AugmentedSubmittable<(shard: H256 | string | Uint8Array, blockNumber: u64 | AnyNumber | Uint8Array, nextFinalizationCandidateBlockNumber: u64 | AnyNumber | Uint8Array, blockHeaderHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, u64, u64, H256]>;
    ...
    utility: {
       ...
       * - O(1).
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: RococoParachainRuntimeOriginCaller | { system: any } | { Void: any } | { Council: any } | { TechnicalCommittee: any } | { PolkadotXcm: any } | { CumulusXcm: any } | { DeveloperCommittee: any } | { Ethereum: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [RococoParachainRuntimeOriginCaller, Call]>;
      /**
       * Send a batch of dispatch calls.
    ...
    vcManagement: {
      activateSchema: AugmentedSubmittable<(shard: H256 | string | Uint8Array, index: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, u64]>;
      /**
       * add an account to the delegatees
       **/
      addDelegatee: AugmentedSubmittable<(account: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      addSchema: AugmentedSubmittable<(shard: H256 | string | Uint8Array, id: Bytes | string | Uint8Array, content: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, Bytes, Bytes]>;
      disableSchema: AugmentedSubmittable<(shard: H256 | string | Uint8Array, index: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, u64]>;
      /**
       * remove an account from the delegatees
       **/
      removeDelegatee: AugmentedSubmittable<(account: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      requestVc: AugmentedSubmittable<(shard: H256 | string | Uint8Array, assertion: CorePrimitivesAssertion | { A1: any } | { A2: any } | { A3: any } | { A4: any } | { A6: any } | { A7: any } | { A8: any } | { A10: any } | { A11: any } | { A13: any } | { A14: any } | { Achainable: any } | { A20: any } | { OneBlock: any } | { GenericDiscordRole: any } | { BnbDomainHolding: any } | { BnbDigitDomainClub: any } | { VIP3MembershipCard: any } | { WeirdoGhostGangHolder: any } | { LITStaking: any } | { EVMAmountHolding: any } | { BRC20AmountHolder: any } | { CryptoSummary: any } | { TokenHoldingAmount: any } | { PlatformUser: any } | { NftHolder: any } | { Dynamic: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, CorePrimitivesAssertion]>;
      revokeSchema: AugmentedSubmittable<(shard: H256 | string | Uint8Array, index: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, u64]>;
      setAdmin: AugmentedSubmittable<(updated: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      someError: AugmentedSubmittable<(identity: Option<CorePrimitivesIdentity> | null | Uint8Array | CorePrimitivesIdentity | { Twitter: any } | { Discord: any } | { Github: any } | { Substrate: any } | { Evm: any } | { Bitcoin: any } | { Solana: any } | string, error: CorePrimitivesErrorVcmpError | { RequestVCFailed: any } | { UnclassifiedError: any } | string | Uint8Array, reqExtHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Option<CorePrimitivesIdentity>, CorePrimitivesErrorVcmpError, H256]>;
      /**
       * ---------------------------------------------------
       * The following extrinsics are supposed to be called by TEE only
       * ---------------------------------------------------
       **/
      vcIssued: AugmentedSubmittable<(identity: CorePrimitivesIdentity | { Twitter: any } | { Discord: any } | { Github: any } | { Substrate: any } | { Evm: any } | { Bitcoin: any } | { Solana: any } | string | Uint8Array, assertion: CorePrimitivesAssertion | { A1: any } | { A2: any } | { A3: any } | { A4: any } | { A6: any } | { A7: any } | { A8: any } | { A10: any } | { A11: any } | { A13: any } | { A14: any } | { Achainable: any } | { A20: any } | { OneBlock: any } | { GenericDiscordRole: any } | { BnbDomainHolding: any } | { BnbDigitDomainClub: any } | { VIP3MembershipCard: any } | { WeirdoGhostGangHolder: any } | { LITStaking: any } | { EVMAmountHolding: any } | { BRC20AmountHolder: any } | { CryptoSummary: any } | { TokenHoldingAmount: any } | { PlatformUser: any } | { NftHolder: any } | { Dynamic: any } | string | Uint8Array, idGraphHash: H256 | string | Uint8Array, reqExtHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CorePrimitivesIdentity, CorePrimitivesAssertion, H256, H256]>;
    };
    ...
    xTokens: {
       ...
       * messages correctly.
       **/
      transferMulticurrencies: AugmentedSubmittable<(currencies: Vec<ITuple<[RuntimeCommonXcmImplCurrencyId, u128]>> | ([RuntimeCommonXcmImplCurrencyId | { SelfReserve: any } | { ParachainReserve: any } | string | Uint8Array, u128 | AnyNumber | Uint8Array])[], feeItem: u32 | AnyNumber | Uint8Array, dest: XcmVersionedMultiLocation | { V2: any } | { V3: any } | string | Uint8Array, destWeightLimit: XcmV3WeightLimit | { Unlimited: any } | { Limited: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<ITuple<[RuntimeCommonXcmImplCurrencyId, u128]>>, u32, XcmVersionedMultiLocation, XcmV3WeightLimit]>;
      /**

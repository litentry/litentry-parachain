...
import type { CorePrimitivesAssertion, CorePrimitivesErrorErrorDetail, CorePrimitivesIdentity, EthereumLog, EvmCoreErrorExitReason, FrameSupportDispatchDispatchInfo, FrameSupportTokensMiscBalanceStatus, PalletAssetManagerAssetMetadata, PalletDemocracyMetadataOwner, PalletDemocracyVoteAccountVote, PalletDemocracyVoteThreshold, PalletExtrinsicFilterOperationalMode, PalletMultisigTimepoint, PalletParachainStakingDelegationRequestsCancelledScheduledRequest, PalletParachainStakingDelegatorAdded, PalletTeebagOperationalMode, PalletTeebagRsaRequest, PalletTeebagWorkerType, RococoParachainRuntimeProxyType, RuntimeCommonXcmImplCurrencyId, SpRuntimeDispatchError, SpWeightsWeightV2Weight, XcmV3MultiAsset, XcmV3MultiLocation, XcmV3MultiassetMultiAssets, XcmV3Response, XcmV3TraitsError, XcmV3TraitsOutcome, XcmV3Xcm, XcmVersionedMultiAssets, XcmVersionedMultiLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      ForeignAssetMetadataUpdated: AugmentedEvent<ApiType, [assetId: u128, metadata: PalletAssetManagerAssetMetadata], { assetId: u128, metadata: PalletAssetManagerAssetMetadata }>;
      /**
       * AssetTracker manipulated
       **/
      ForeignAssetTrackerUpdated: AugmentedEvent<ApiType, [oldAssetTracker: u128, newAssetTracker: u128], { oldAssetTracker: u128, newAssetTracker: u128 }>;
      /**
       * New asset with the asset manager is registered
       **/
      ForeignAssetTypeRegistered: AugmentedEvent<ApiType, [assetId: u128, assetType: RuntimeCommonXcmImplCurrencyId], { assetId: u128, assetType: RuntimeCommonXcmImplCurrencyId }>;
      /**
       ...
       **/
      ForeignAssetTypeRemoved: AugmentedEvent<ApiType, [assetId: u128, removedAssetType: RuntimeCommonXcmImplCurrencyId, defaultAssetType: RuntimeCommonXcmImplCurrencyId], { assetId: u128, removedAssetType: RuntimeCommonXcmImplCurrencyId, defaultAssetType: RuntimeCommonXcmImplCurrencyId }>;
      /**
    ...
    bitacross: {
      ...
      BtcWalletGenerated: AugmentedEvent<ApiType, [pubKey: U8aFixed, accountId: AccountId32], { pubKey: U8aFixed, accountId: AccountId32 }>;
    ...
    evmAssertions: {
      AssertionCreated: AugmentedEvent<ApiType, [id: H160, byteCode: Bytes, secrets: Vec<Bytes>], { id: H160, byteCode: Bytes, secrets: Vec<Bytes> }>;
    };
    extrinsicFilter: {
      /**
       * some extrinsics are blocked
       **/
      ExtrinsicsBlocked: AugmentedEvent<ApiType, [palletNameBytes: Bytes, functionNameBytes: Option<Bytes>], { palletNameBytes: Bytes, functionNameBytes: Option<Bytes> }>;
      /**
       * some extrinsics are unblocked
       **/
      ExtrinsicsUnblocked: AugmentedEvent<ApiType, [palletNameBytes: Bytes, functionNameBytes: Option<Bytes>], { palletNameBytes: Bytes, functionNameBytes: Option<Bytes> }>;
      /**
       * a new mode was just sent
       **/
      ModeSet: AugmentedEvent<ApiType, [newMode: PalletExtrinsicFilterOperationalMode], { newMode: PalletExtrinsicFilterOperationalMode }>;
    };
    identityManagement: {
      ActivateIdentityFailed: AugmentedEvent<ApiType, [primeIdentity: Option<CorePrimitivesIdentity>, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256], { primeIdentity: Option<CorePrimitivesIdentity>, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256 }>;
      ActivateIdentityRequested: AugmentedEvent<ApiType, [shard: H256, account: AccountId32, encryptedIdentity: Bytes], { shard: H256, account: AccountId32, encryptedIdentity: Bytes }>;
      DeactivateIdentityFailed: AugmentedEvent<ApiType, [primeIdentity: Option<CorePrimitivesIdentity>, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256], { primeIdentity: Option<CorePrimitivesIdentity>, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256 }>;
      DeactivateIdentityRequested: AugmentedEvent<ApiType, [shard: H256, account: AccountId32, encryptedIdentity: Bytes], { shard: H256, account: AccountId32, encryptedIdentity: Bytes }>;
      ...
      IdentityActivated: AugmentedEvent<ApiType, [primeIdentity: CorePrimitivesIdentity, idGraphHash: H256, reqExtHash: H256], { primeIdentity: CorePrimitivesIdentity, idGraphHash: H256, reqExtHash: H256 }>;
      IdentityDeactivated: AugmentedEvent<ApiType, [primeIdentity: CorePrimitivesIdentity, idGraphHash: H256, reqExtHash: H256], { primeIdentity: CorePrimitivesIdentity, idGraphHash: H256, reqExtHash: H256 }>;
      IdentityLinked: AugmentedEvent<ApiType, [primeIdentity: CorePrimitivesIdentity, idGraphHash: H256, reqExtHash: H256], { primeIdentity: CorePrimitivesIdentity, idGraphHash: H256, reqExtHash: H256 }>;
      IdentityNetworksSet: AugmentedEvent<ApiType, [primeIdentity: CorePrimitivesIdentity, idGraphHash: H256, reqExtHash: H256], { primeIdentity: CorePrimitivesIdentity, idGraphHash: H256, reqExtHash: H256 }>;
      LinkIdentityFailed: AugmentedEvent<ApiType, [primeIdentity: Option<CorePrimitivesIdentity>, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256], { primeIdentity: Option<CorePrimitivesIdentity>, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256 }>;
      LinkIdentityRequested: AugmentedEvent<ApiType, [shard: H256, account: AccountId32, encryptedIdentity: Bytes, encryptedValidationData: Bytes, encryptedWeb3networks: Bytes], { shard: H256, account: AccountId32, encryptedIdentity: Bytes, encryptedValidationData: Bytes, encryptedWeb3networks: Bytes }>;
      UnclassifiedError: AugmentedEvent<ApiType, [primeIdentity: Option<CorePrimitivesIdentity>, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256], { primeIdentity: Option<CorePrimitivesIdentity>, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256 }>;
    };
    ...
    proxy: {
       ...
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: RococoParachainRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: RococoParachainRuntimeProxyType, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: RococoParachainRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: RococoParachainRuntimeProxyType, delay: u32 }>;
      /**
       * A pure account has been created by new proxy with given
       * disambiguation index and proxy type.
       **/
      PureCreated: AugmentedEvent<ApiType, [pure: AccountId32, who: AccountId32, proxyType: RococoParachainRuntimeProxyType, disambiguationIndex: u16], { pure: AccountId32, who: AccountId32, proxyType: RococoParachainRuntimeProxyType, disambiguationIndex: u16 }>;
    };
    scheduler: {
      /**
    ...
    teebag: {
      AdminSet: AugmentedEvent<ApiType, [newAdmin: Option<AccountId32>], { newAdmin: Option<AccountId32> }>;
      EnclaveAdded: AugmentedEvent<ApiType, [who: AccountId32, workerType: PalletTeebagWorkerType, url: Bytes], { who: AccountId32, workerType: PalletTeebagWorkerType, url: Bytes }>;
      EnclaveAuthorized: AugmentedEvent<ApiType, [workerType: PalletTeebagWorkerType, mrenclave: U8aFixed], { workerType: PalletTeebagWorkerType, mrenclave: U8aFixed }>;
      EnclaveRemoved: AugmentedEvent<ApiType, [who: AccountId32], { who: AccountId32 }>;
      EnclaveUnauthorized: AugmentedEvent<ApiType, [workerType: PalletTeebagWorkerType, mrenclave: U8aFixed], { workerType: PalletTeebagWorkerType, mrenclave: U8aFixed }>;
      ...
      ParentchainBlockProcessed: AugmentedEvent<ApiType, [who: AccountId32, blockNumber: u32, blockHash: H256, taskMerkleRoot: H256], { who: AccountId32, blockNumber: u32, blockHash: H256, taskMerkleRoot: H256 }>;
      SidechainBlockFinalized: AugmentedEvent<ApiType, [who: AccountId32, sidechainBlockNumber: u64], { who: AccountId32, sidechainBlockNumber: u64 }>;
    };
    tips: {
      /**
    ...
    vcManagement: {
      ...
      DelegateeAdded: AugmentedEvent<ApiType, [account: AccountId32], { account: AccountId32 }>;
      DelegateeRemoved: AugmentedEvent<ApiType, [account: AccountId32], { account: AccountId32 }>;
      RequestVCFailed: AugmentedEvent<ApiType, [identity: Option<CorePrimitivesIdentity>, assertion: CorePrimitivesAssertion, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256], { identity: Option<CorePrimitivesIdentity>, assertion: CorePrimitivesAssertion, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256 }>;
      ...
      UnclassifiedError: AugmentedEvent<ApiType, [identity: Option<CorePrimitivesIdentity>, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256], { identity: Option<CorePrimitivesIdentity>, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256 }>;
      VCIssued: AugmentedEvent<ApiType, [identity: CorePrimitivesIdentity, assertion: CorePrimitivesAssertion, idGraphHash: H256, reqExtHash: H256], { identity: CorePrimitivesIdentity, assertion: CorePrimitivesAssertion, idGraphHash: H256, reqExtHash: H256 }>;

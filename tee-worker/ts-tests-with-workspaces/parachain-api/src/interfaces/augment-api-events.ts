        ...
        identityManagementMock: {
            ...
            IdentityCreatedPlain: AugmentedEvent<
                ...
                [
                    ...
                    idGraph: Vec<
                        ITuple<
                            [MockTeePrimitivesIdentity, PalletIdentityManagementMockIdentityContext]
                        >
                    >
                ],
                {
            ...
            RemoveIdentityRequested: AugmentedEvent<ApiType, [shard: H256], { shard: H256 }>;
            SetUserShieldingKeyRequested: AugmentedEvent<ApiType, [shard: H256], { shard: H256 }>;
            SomeError: AugmentedEvent<
                ApiType,
                [func: Bytes, error: Bytes],
                { func: Bytes; error: Bytes }
            >;
            UserShieldingKeySet: AugmentedEvent<
                ApiType,
                ...
                { account: AccountId32 }
            >;
            UserShieldingKeySetPlain: AugmentedEvent<
                ApiType,
                [account: AccountId32],
                { account: AccountId32 }
            >;

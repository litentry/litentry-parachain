...
declare module '@polkadot/api-base/types/events' {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        ...
        identityManagement: {
            CreateIdentityFailed: AugmentedEvent<ApiType, [
            ...
            CreateIdentityRequested: AugmentedEvent<ApiType, [shard: H256], {
                shard: H256;
            }>;
            ...
            IdentityCreated: AugmentedEvent<ApiType, [
                account: AccountId32,
            ...
            IdentityRemoved: AugmentedEvent<ApiType, [
                account: AccountId32,
                identity: CorePrimitivesKeyAesOutput,
                reqExtHash: H256
            ], {
            ...
            IdentityVerified: AugmentedEvent<ApiType, [
                account: AccountId32,
                identity: CorePrimitivesKeyAesOutput,
            ...
            RemoveIdentityFailed: AugmentedEvent<ApiType, [
                account: Option<AccountId32>,
                detail: CorePrimitivesErrorErrorDetail,
                reqExtHash: H256
            ], {
            ...
            RemoveIdentityRequested: AugmentedEvent<ApiType, [shard: H256], {
                shard: H256;
            }>;
            ...
            VerifyIdentityFailed: AugmentedEvent<ApiType, [
                account: Option<AccountId32>,
                detail: CorePrimitivesErrorErrorDetail,
                reqExtHash: H256
            ], {
            ...
            VerifyIdentityRequested: AugmentedEvent<ApiType, [shard: H256], {
                shard: H256;
            }>;
            /**
             * Generic event
        ...
        identityManagementMock: {
            ...
            IdentityCreatedPlain: AugmentedEvent<ApiType, [
                account: AccountId32,
            ...
            IdentityRemovedPlain: AugmentedEvent<ApiType, [
                account: AccountId32,
                identity: MockTeePrimitivesIdentity,
                idGraph: Vec<ITuple<[MockTeePrimitivesIdentity, PalletIdentityManagementMockIdentityContext]>>
            ], {
            ...
            IdentityVerifiedPlain: AugmentedEvent<ApiType, [
                account: AccountId32,
                identity: MockTeePrimitivesIdentity,
                idGraph: Vec<ITuple<[MockTeePrimitivesIdentity, PalletIdentityManagementMockIdentityContext]>>
            ], {
            ...
            SomeError: AugmentedEvent<ApiType, [func: Bytes, error: Bytes], {
                func: Bytes;
                error: Bytes;
            }>;
            UserShieldingKeySet: AugmentedEvent<ApiType, [account: AccountId32], {
                account: AccountId32;
            }>;
            UserShieldingKeySetPlain: AugmentedEvent<ApiType, [account: AccountId32], {
                account: AccountId32;
            }>;
            VerifyIdentityRequested: AugmentedEvent<ApiType, [shard: H256], {
                shard: H256;

...
export interface TrustedCall extends Enum {
    ...
    readonly type: 'BalanceSetBalance' | 'BalanceTransfer' | 'BalanceUnshield' | 'BalanceShield' | 'SetUserShieldingKey' | 'CreateIdentity' | 'RemoveIdentity' | 'VerifyIdentity' | 'RequestVc';
}
...
export interface TrustedGetter extends Enum {
    ...
    readonly type: 'FreeBalance' | 'ReservedBalance' | 'Nonce' | 'UserShieldingKey' | 'IdGraph' | 'ChallengeCode' | 'IdGraphStats';
}

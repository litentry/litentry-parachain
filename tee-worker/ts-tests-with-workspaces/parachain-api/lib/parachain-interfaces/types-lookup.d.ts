...
declare module '@polkadot/types/lookup' {
    ...
    interface CorePrimitivesErrorErrorDetail extends Enum {
        ...
        readonly type: 'ImportError' | 'StfError' | 'SendStfRequestFailed' | 'ChallengeCodeNotFound' | 'UserShieldingKeyNotFound' | 'ParseError' | 'DataProviderError' | 'InvalidIdentity' | 'WrongWeb2Handle' | 'UnexpectedMessage' | 'WrongSignatureType' | 'VerifySubstrateSignatureFailed' | 'VerifyEvmSignatureFailed' | 'RecoverEvmAddressFailed';
    }
    ...
    interface PalletVcManagementEvent extends Enum {
        ...
        readonly type: 'VcRequested' | 'VcDisabled' | 'VcRevoked' | 'VcIssued' | 'AdminChanged' | 'SchemaIssued' | 'SchemaDisabled' | 'SchemaActivated' | 'SchemaRevoked' | 'RequestVCFailed' | 'UnclassifiedError' | 'VcRegistryItemAdded' | 'VcRegistryItemRemoved' | 'VcRegistryCleared';
    }
    ...
    interface PalletTeerexEvent extends Enum {
        ...
        readonly type: 'AdminChanged' | 'AddedEnclave' | 'RemovedEnclave' | 'Forwarded' | 'ShieldFunds' | 'UnshieldedFunds' | 'ProcessedParentchainBlock' | 'SetHeartbeatTimeout' | 'UpdatedScheduledEnclave' | 'RemovedScheduledEnclave' | 'PublishedHash';
    }
    ...
    interface PalletIdentityManagementCall extends Enum {
        ...
        readonly type: 'AddDelegatee' | 'RemoveDelegatee' | 'SetUserShieldingKey' | 'CreateIdentity' | 'RemoveIdentity' | 'VerifyIdentity' | 'UserShieldingKeySet' | 'IdentityCreated' | 'IdentityRemoved' | 'IdentityVerified' | 'SomeError';
    }
    ...
    interface CorePrimitivesErrorImpError extends Enum {
        ...
        readonly type: 'SetUserShieldingKeyFailed' | 'CreateIdentityFailed' | 'RemoveIdentityFailed' | 'VerifyIdentityFailed' | 'ImportScheduledEnclaveFailed' | 'UnclassifiedError';
    }
    ...
    interface PalletVcManagementCall extends Enum {
        ...
        readonly type: 'RequestVc' | 'DisableVc' | 'RevokeVc' | 'SetAdmin' | 'AddSchema' | 'DisableSchema' | 'ActivateSchema' | 'RevokeSchema' | 'AddVcRegistryItem' | 'RemoveVcRegistryItem' | 'ClearVcRegistry' | 'VcIssued' | 'SomeError';
    }
    ...
    interface PalletTeerexCall extends Enum {
        ...
        readonly type: 'RegisterEnclave' | 'UnregisterEnclave' | 'CallWorker' | 'ConfirmProcessedParentchainBlock' | 'ShieldFunds' | 'UnshieldFunds' | 'SetHeartbeatTimeout' | 'RegisterDcapEnclave' | 'UpdateScheduledEnclave' | 'RegisterQuotingEnclave' | 'RemoveScheduledEnclave' | 'RegisterTcbInfo' | 'PublishHash' | 'SetAdmin';
    }
    ...
    interface PalletVcManagementError extends Enum {
        ...
        readonly type: 'VcAlreadyExists' | 'VcNotExist' | 'VcSubjectMismatch' | 'VcAlreadyDisabled' | 'RequireAdmin' | 'SchemaNotExists' | 'SchemaAlreadyDisabled' | 'SchemaAlreadyActivated' | 'SchemaIndexOverFlow' | 'LengthMismatch';
    }

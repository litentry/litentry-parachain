...
declare module '@polkadot/api-base/types/submittable' {
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
        ...
        identityManagement: {
             ...
             **/
            createIdentity: AugmentedSubmittable<(shard: H256 | string | Uint8Array, user: AccountId32 | string | Uint8Array, encryptedIdentity: Bytes | string | Uint8Array, encryptedMetadata: Option<Bytes> | null | Uint8Array | Bytes | string) => SubmittableExtrinsic<ApiType>, [
                H256,
                AccountId32,
                Bytes,
                Option<Bytes>
            ]>;
            identityCreated: AugmentedSubmittable<(account: AccountId32 | string | Uint8Array, identity: CorePrimitivesKeyAesOutput | {
                ciphertext?: any;
                aad?: any;
                nonce?: any;
            } | string | Uint8Array, code: CorePrimitivesKeyAesOutput | {
                ciphertext?: any;
                aad?: any;
                nonce?: any;
            ...
            identityRemoved: AugmentedSubmittable<(account: AccountId32 | string | Uint8Array, identity: CorePrimitivesKeyAesOutput | {
                ciphertext?: any;
                aad?: any;
                nonce?: any;
            } | string | Uint8Array, reqExtHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
            ...
            identityVerified: AugmentedSubmittable<(account: AccountId32 | string | Uint8Array, identity: CorePrimitivesKeyAesOutput | {
                ciphertext?: any;
                aad?: any;
                nonce?: any;
             ...
             * Remove an identity
             **/
            removeIdentity: AugmentedSubmittable<(shard: H256 | string | Uint8Array, encryptedIdentity: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                H256,
                Bytes
            ]>;
            /**
             ...
             * Verify an identity
             **/
            verifyIdentity: AugmentedSubmittable<(shard: H256 | string | Uint8Array, encryptedIdentity: Bytes | string | Uint8Array, encryptedValidationData: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                H256,
                Bytes,
                Bytes
            ]>;
        ...
        identityManagementMock: {
            ...
            someError: AugmentedSubmittable<(func: Bytes | string | Uint8Array, error: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                Bytes,
                Bytes
            ]>;
            userShieldingKeySet: AugmentedSubmittable<(account: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                AccountId32
            ]>;
            /**
        ...
        teerex: {
             ...
             **/
            confirmProcessedParentchainBlock: AugmentedSubmittable<(blockHash: H256 | string | Uint8Array, blockNumber: u32 | AnyNumber | Uint8Array, trustedCallsMerkleRoot: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                H256,
                u32,
                H256
            ]>;
            ...
            removeScheduledEnclave: AugmentedSubmittable<(sidechainBlockNumber: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u64
            ]>;
            /**
             * Change the admin account
            ...
            setHeartbeatTimeout: AugmentedSubmittable<(timeout: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u64
            ]>;
            /**
            ...
            updateScheduledEnclave: AugmentedSubmittable<(sidechainBlockNumber: u64 | AnyNumber | Uint8Array, mrEnclave: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u64,
                U8aFixed
            ]>;
            /**

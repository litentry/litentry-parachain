...
declare module "@polkadot/types/lookup" {
    ...
    interface CorePrimitivesAssertionAchainableParams extends Enum {
        ...
        readonly asMirror: CorePrimitivesAssertionAchainableMirror;
        readonly type:
            | "AmountHolding"
            | "AmountToken"
            | "Amount"
    ...
    /** @name CorePrimitivesAssertionAchainableMirror (164) */
    interface CorePrimitivesAssertionAchainableMirror extends Struct {
        readonly name: Bytes;
        readonly chain: CorePrimitivesNetworkWeb3Network;
    ...
    /** @name TeerexPrimitivesRsaRequest (360) */

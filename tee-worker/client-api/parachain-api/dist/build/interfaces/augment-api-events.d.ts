...
declare module "@polkadot/api-base/types/events" {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        ...
        drop3: {
             ...
             **/
            RewardSent: AugmentedEvent<ApiType, [
                to: AccountId32,
                amount: u128
            ], {
                to: AccountId32;
        ...
        identityManagement: {
            ...
            DelegateeAdded: AugmentedEvent<ApiType, [
                account: AccountId32
            ], {
                account: AccountId32;
            }>;
            DelegateeRemoved: AugmentedEvent<ApiType, [
                account: AccountId32
            ], {
                account: AccountId32;
            }>;
        ...
        parachainStaking: {
            ...
            CandidateWhiteListAdded: AugmentedEvent<ApiType, [
                candidate: AccountId32
            ], {
                candidate: AccountId32;
            }>;
            CandidateWhiteListRemoved: AugmentedEvent<ApiType, [
                candidate: AccountId32
            ], {
                candidate: AccountId32;
            }>;
             ...
             **/
            TotalSelectedSet: AugmentedEvent<ApiType, [
                old: u32,
                new_: u32
            ], {
                old: u32;
        ...
        teeracle: {
             ...
             **/
            ExchangeRateUpdated: AugmentedEvent<ApiType, [
                Bytes,
                Bytes,
        ...
        teerex: {
            ...
            NewMrenclaveSet: AugmentedEvent<ApiType, [
        ...
        xcmpQueue: {
             ...
             * Bad XCM format used.
             **/
            BadFormat: AugmentedEvent<ApiType, [
                messageHash: Option<U8aFixed>
            ], {
                messageHash: Option<U8aFixed>;
            }>;
             ...
             **/
            BadVersion: AugmentedEvent<ApiType, [
                messageHash: Option<U8aFixed>
            ], {
                messageHash: Option<U8aFixed>;
            }>;

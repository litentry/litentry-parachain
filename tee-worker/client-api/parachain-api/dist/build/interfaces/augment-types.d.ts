...
import type { Address20, Address32, AesOutput, AesRequest, Assertion, AssertionSupportedNetwork, BoundedWeb3Network, DirectRequestStatus, DiscordValidationData, ErrorDetail, GenericEventWithAccount, Getter, IdentityContext, IdentityGenericEvent, IdentityStatus, IdentityString, LinkIdentityResult, LitentryIdentity, LitentryMultiSignature, LitentryValidationData, PublicGetter, RequestVCResult, RsaRequest, SetUserShieldingKeyResult, ShardIdentifier, StfError, TrustedCall, TrustedCallSigned, TrustedGetter, TrustedGetterSigned, TrustedOperation, TrustedOperationStatus, TwitterValidationData, UserShieldingKeyNonceType, UserShieldingKeyType, VCRequested, Web2ValidationData, Web3CommonValidationData, Web3Network, Web3ValidationData, WorkerRpcReturnValue } from "parachain-api/interfaces/identity";

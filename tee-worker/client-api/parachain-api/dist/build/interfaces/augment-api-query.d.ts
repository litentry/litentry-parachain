...
declare module "@polkadot/api-base/types/storage" {
    interface AugmentedQueries<ApiType extends ApiTypes> {
        ...
        chainBridge: {
            ...
            bridgeFee: AugmentedQuery<ApiType, (arg: u8 | AnyNumber | Uint8Array) => Observable<Option<u128>>, [
                u8
            ]>;
            chainNonces: AugmentedQuery<ApiType, (arg: u8 | AnyNumber | Uint8Array) => Observable<Option<u64>>, [
                u8
            ]>;
        ...
        sidechain: {
            ...
            workerForShard: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<u64>, [
                H256
            ]>;
        };
        sudo: {
        ...
        teerex: {
            ...
            executedCalls: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<u64>, [
                H256
            ]>;
        ...
        tips: {
             ...
             **/
            reasons: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<Bytes>>, [
                H256
            ]>;
            /**
        ...
        tokens: {
             ...
             **/
            totalIssuance: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<u128>, [
                u128
            ]>;
        };
        transactionPayment: {

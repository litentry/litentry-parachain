    ...
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
        ...
        identityManagement: {
            ...
            setUserShieldingKey: AugmentedSubmittable<(who: LitentryPrimitivesIdentity | {
                ...
                Evm: any;
            } | string | Uint8Array, key: U8aFixed | string | Uint8Array, networks: Vec<CorePrimitivesNetworkWeb3Network> | (CorePrimitivesNetworkWeb3Network | "Polkadot" | "Kusama" | "Litentry" | "Litmus" | "LitentryRococo" | "Khala" | "SubstrateTestnet" | "Ethereum" | "Bsc" | number | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [
                LitentryPrimitivesIdentity,
                U8aFixed,
                Vec<CorePrimitivesNetworkWeb3Network>
            ]>;

...
use crate::listener::IntentionEvent;
...
#[async_trait]
pub trait IntentionEventsFetcher<Id: Clone> {
	async fn get_block_events(&mut self, block_num: u64) -> Result<Vec<IntentionEvent<Id>>, ()>;
}

...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    identityManagement: {
      idGraphLens: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<u32>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * ID graph is per Litentry account + identity
       **/
      idGraphs: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: LitentryPrimitivesIdentity | { Substrate: any } | { Evm: any } | { Web2: any } | string | Uint8Array) => Observable<Option<PalletIdentityManagementTeeIdentityContext>>, [AccountId32, LitentryPrimitivesIdentity]> & QueryableStorageEntry<ApiType, [AccountId32, LitentryPrimitivesIdentity]>;
      /**
       * user shielding key is per Litentry account
       **/
      userShieldingKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<U8aFixed>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;

...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      assetIdMetadata: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletAssetManagerAssetMetadata>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       * Mapping from an asset id to asset type.
       * This is mostly used when receiving transaction specifying an asset directly,
       * like transferring an asset from this chain to another.
       **/
      assetIdType: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<RuntimeCommonXcmImplCurrencyId>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       ...
       **/
      assetIdUnitsPerSecond: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<u128>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       * Reverse mapping of AssetIdType. Mapping from an asset type to an asset id.
       * This is mostly used when receiving a multilocation XCM message to retrieve
       * the corresponding asset in which tokens should me minted.
       **/
      assetTypeId: AugmentedQuery<ApiType, (arg: RuntimeCommonXcmImplCurrencyId | { SelfReserve: any } | { ParachainReserve: any } | string | Uint8Array) => Observable<Option<u128>>, [RuntimeCommonXcmImplCurrencyId]> & QueryableStorageEntry<ApiType, [RuntimeCommonXcmImplCurrencyId]>;
      /**
       * Stores the tracker of foreign assets id that have been
       * created so far
       **/
      foreignAssetTracker: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    chainBridge: {
      ...
      votes: AugmentedQuery<ApiType, (arg1: u8 | AnyNumber | Uint8Array, arg2: ITuple<[u64, Call]> | [u64 | AnyNumber | Uint8Array, Call | IMethod | string | Uint8Array]) => Observable<Option<PalletBridgeProposalVotes>>, [u8, ITuple<[u64, Call]>]> & QueryableStorageEntry<ApiType, [u8, ITuple<[u64, Call]>]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    drop3: {
       ...
       **/
      rewardPoolOwners: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<AccountId32>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
      /**
       * Map for PoolId <> RewardPool
       **/
      rewardPools: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<PalletDrop3RewardPool>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    extrinsicFilter: {
       ...
       * blocked
       **/
      blockedExtrinsics: AugmentedQuery<ApiType, (arg: ITuple<[Bytes, Bytes]> | [Bytes | string | Uint8Array, Bytes | string | Uint8Array]) => Observable<Option<Null>>, [ITuple<[Bytes, Bytes]>]> & QueryableStorageEntry<ApiType, [ITuple<[Bytes, Bytes]>]>;
      /**
       * current mode, ValueQuery as it can't be None
       **/
      mode: AugmentedQuery<ApiType, () => Observable<PalletExtrinsicFilterOperationalMode>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<RococoParachainRuntimeSessionKeys>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, RococoParachainRuntimeSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    teeracle: {
       ...
       **/
      exchangeRates: AugmentedQuery<ApiType, (arg1: Bytes | string | Uint8Array, arg2: Bytes | string | Uint8Array) => Observable<SubstrateFixedFixedU64>, [Bytes, Bytes]> & QueryableStorageEntry<ApiType, [Bytes, Bytes]>;
      oracleData: AugmentedQuery<ApiType, (arg1: Bytes | string | Uint8Array, arg2: Bytes | string | Uint8Array) => Observable<Bytes>, [Bytes, Bytes]> & QueryableStorageEntry<ApiType, [Bytes, Bytes]>;
      /**
       * whitelist of trusted oracle's releases for different data sources
       **/
      whitelists: AugmentedQuery<ApiType, (arg: Bytes | string | Uint8Array) => Observable<Vec<U8aFixed>>, [Bytes]> & QueryableStorageEntry<ApiType, [Bytes]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;

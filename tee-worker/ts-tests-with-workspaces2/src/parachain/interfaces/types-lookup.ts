...
declare module '@polkadot/types/lookup' {
    ...
    interface PalletIdentityManagementEvent extends Enum {
        ...
        readonly type: 'DelegateeAdded' | 'DelegateeRemoved' | 'LinkIdentityRequested' | 'RemoveIdentityRequested' | 'SetUserShieldingKeyRequested' | 'UserShieldingKeySet' | 'IdentityLinked' | 'IdentityRemoved' | 'SetUserShieldingKeyFailed' | 'LinkIdentityFailed' | 'RemoveIdentityFailed' | 'ImportScheduledEnclaveFailed' | 'UnclassifiedError';
    }
    ...
    interface CorePrimitivesErrorErrorDetail extends Enum {
        ...
        readonly type: 'ImportError' | 'UnauthorizedSigner' | 'StfError' | 'SendStfRequestFailed' | 'UserShieldingKeyNotFound' | 'ParseError' | 'DataProviderError' | 'InvalidIdentity' | 'WrongWeb2Handle' | 'UnexpectedMessage' | 'WrongSignatureType' | 'VerifySubstrateSignatureFailed' | 'VerifyEvmSignatureFailed' | 'RecoverEvmAddressFailed';
    }
    ...
    interface CorePrimitivesAssertion extends Enum {
        ...
        readonly type: 'A1' | 'A2' | 'A3' | 'A4' | 'A5' | 'A6' | 'A7' | 'A8' | 'A9' | 'A10' | 'A11' | 'A12' | 'A13' | 'A14';
    }
    ...
    interface PalletIdentityManagementCall extends Enum {
        ...
        readonly type: 'AddDelegatee' | 'RemoveDelegatee' | 'SetUserShieldingKey' | 'LinkIdentity' | 'RemoveIdentity' | 'UserShieldingKeySet' | 'IdentityLinked' | 'IdentityRemoved' | 'SomeError';
    }
    ...
    interface CorePrimitivesErrorImpError extends Enum {
        ...
        readonly type: 'SetUserShieldingKeyFailed' | 'LinkIdentityFailed' | 'RemoveIdentityFailed' | 'ImportScheduledEnclaveFailed' | 'UnclassifiedError';
    }

...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    drop3: {
       ...
       **/
      proposeRewardPool: AugmentedSubmittable<(name: Bytes | string | Uint8Array, total: u128 | AnyNumber | Uint8Array, startAt: u32 | AnyNumber | Uint8Array, endAt: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, u128, u32, u32]>;
      /**
       ...
       **/
      sendReward: AugmentedSubmittable<(id: u64 | AnyNumber | Uint8Array, to: AccountId32 | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, AccountId32, u128]>;
      /**
    ...
    identityManagement: {
      ...
      identityLinked: AugmentedSubmittable<(account: AccountId32 | string | Uint8Array, identity: CorePrimitivesKeyAesOutput | { ciphertext?: any; aad?: any; nonce?: any } | string | Uint8Array, idGraph: CorePrimitivesKeyAesOutput | { ciphertext?: any; aad?: any; nonce?: any } | string | Uint8Array, reqExtHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, CorePrimitivesKeyAesOutput, CorePrimitivesKeyAesOutput, H256]>;
      identityRemoved: AugmentedSubmittable<(account: AccountId32 | string | Uint8Array, identity: CorePrimitivesKeyAesOutput | { ciphertext?: any; aad?: any; nonce?: any } | string | Uint8Array, reqExtHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, CorePrimitivesKeyAesOutput, H256]>;
      /**
       ...
       **/
      linkIdentity: AugmentedSubmittable<(shard: H256 | string | Uint8Array, user: AccountId32 | string | Uint8Array, encryptedIdentity: Bytes | string | Uint8Array, encryptedValidationData: Bytes | string | Uint8Array, nonce: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, AccountId32, Bytes, Bytes, U8aFixed]>;
      /**
       ...
       * Remove an identity
       **/
      removeIdentity: AugmentedSubmittable<(shard: H256 | string | Uint8Array, encryptedIdentity: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, Bytes]>;
      /**
       * Set or update user's shielding key
       **/
      setUserShieldingKey: AugmentedSubmittable<(shard: H256 | string | Uint8Array, encryptedKey: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, Bytes]>;
      someError: AugmentedSubmittable<(account: Option<AccountId32> | null | Uint8Array | AccountId32 | string, error: CorePrimitivesErrorImpError | { SetUserShieldingKeyFailed: any } | { LinkIdentityFailed: any } | { RemoveIdentityFailed: any } | { ImportScheduledEnclaveFailed: any } | { UnclassifiedError: any } | string | Uint8Array, reqExtHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Option<AccountId32>, CorePrimitivesErrorImpError, H256]>;
      /**
       * ---------------------------------------------------
       * The following extrinsics are supposed to be called by TEE only
       * ---------------------------------------------------
       **/
      userShieldingKeySet: AugmentedSubmittable<(account: AccountId32 | string | Uint8Array, idGraph: CorePrimitivesKeyAesOutput | { ciphertext?: any; aad?: any; nonce?: any } | string | Uint8Array, reqExtHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, CorePrimitivesKeyAesOutput, H256]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    sidechain: {
       ...
       **/
      confirmImportedSidechainBlock: AugmentedSubmittable<(shardId: H256 | string | Uint8Array, blockNumber: u64 | AnyNumber | Uint8Array, nextFinalizationCandidateBlockNumber: u64 | AnyNumber | Uint8Array, blockHeaderHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, u64, u64, H256]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    teeracle: {
      addToWhitelist: AugmentedSubmittable<(dataSource: Bytes | string | Uint8Array, mrenclave: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, U8aFixed]>;
      removeFromWhitelist: AugmentedSubmittable<(dataSource: Bytes | string | Uint8Array, mrenclave: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, U8aFixed]>;
      updateExchangeRate: AugmentedSubmittable<(dataSource: Bytes | string | Uint8Array, tradingPair: Bytes | string | Uint8Array, newValue: Option<SubstrateFixedFixedU64> | null | Uint8Array | SubstrateFixedFixedU64 | { bits?: any } | string) => SubmittableExtrinsic<ApiType>, [Bytes, Bytes, Option<SubstrateFixedFixedU64>]>;
      updateOracle: AugmentedSubmittable<(oracleName: Bytes | string | Uint8Array, dataSource: Bytes | string | Uint8Array, newBlob: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, Bytes, Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    teerex: {
      callWorker: AugmentedSubmittable<(request: TeerexPrimitivesRequest | { shard?: any; cyphertext?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [TeerexPrimitivesRequest]>;
      /**
       * The integritee worker calls this function for every processed parentchain_block to
       * confirm a state update.
       **/
      confirmProcessedParentchainBlock: AugmentedSubmittable<(blockHash: H256 | string | Uint8Array, blockNumber: Compact<u32> | AnyNumber | Uint8Array, trustedCallsMerkleRoot: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, Compact<u32>, H256]>;
      /**
       ...
       **/
      publishHash: AugmentedSubmittable<(hash: H256 | string | Uint8Array, extraTopics: Vec<H256> | (H256 | string | Uint8Array)[], data: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, Vec<H256>, Bytes]>;
      registerDcapEnclave: AugmentedSubmittable<(dcapQuote: Bytes | string | Uint8Array, workerUrl: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, Bytes]>;
      registerEnclave: AugmentedSubmittable<(raReport: Bytes | string | Uint8Array, workerUrl: Bytes | string | Uint8Array, shieldingKey: Option<Bytes> | null | Uint8Array | Bytes | string, vcPubkey: Option<Bytes> | null | Uint8Array | Bytes | string) => SubmittableExtrinsic<ApiType>, [Bytes, Bytes, Option<Bytes>, Option<Bytes>]>;
      ...
      removeScheduledEnclave: AugmentedSubmittable<(sidechainBlockNumber: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64]>;
      /**
       * Change the admin account
       * similar to sudo.set_key, the old account will be supplied in event
       **/
      setAdmin: AugmentedSubmittable<(updated: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      setHeartbeatTimeout: AugmentedSubmittable<(timeout: Compact<u64> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u64>]>;
      /**
       ...
       * shard.
       **/
      shieldFunds: AugmentedSubmittable<(incognitoAccountEncrypted: Bytes | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, bondingAccount: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, u128, AccountId32]>;
       ...
       **/
      unshieldFunds: AugmentedSubmittable<(publicAccount: AccountId32 | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, bondingAccount: AccountId32 | string | Uint8Array, callHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, u128, AccountId32, H256]>;
      updateScheduledEnclave: AugmentedSubmittable<(sidechainBlockNumber: Compact<u64> | AnyNumber | Uint8Array, mrEnclave: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u64>, U8aFixed]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    utility: {
       ...
       * - O(1).
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: RococoParachainRuntimeOriginCaller | { system: any } | { Void: any } | { Council: any } | { TechnicalCommittee: any } | { PolkadotXcm: any } | { CumulusXcm: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [RococoParachainRuntimeOriginCaller, Call]>;
      /**
       * Send a batch of dispatch calls.
    ...
    vcManagement: {
      ...
      requestVc: AugmentedSubmittable<(shard: H256 | string | Uint8Array, assertion: CorePrimitivesAssertion | { A1: any } | { A2: any } | { A3: any } | { A4: any } | { A5: any } | { A6: any } | { A7: any } | { A8: any } | { A9: any } | { A10: any } | { A11: any } | { A12: any } | { A13: any } | { A14: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, CorePrimitivesAssertion]>;
      ...
      setAdmin: AugmentedSubmittable<(updated: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      someError: AugmentedSubmittable<(account: Option<AccountId32> | null | Uint8Array | AccountId32 | string, error: CorePrimitivesErrorVcmpError | { RequestVCFailed: any } | { UnclassifiedError: any } | string | Uint8Array, reqExtHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Option<AccountId32>, CorePrimitivesErrorVcmpError, H256]>;
      /**
       * ---------------------------------------------------
       * The following extrinsics are supposed to be called by TEE only
       * ---------------------------------------------------
       **/
      vcIssued: AugmentedSubmittable<(account: AccountId32 | string | Uint8Array, assertion: CorePrimitivesAssertion | { A1: any } | { A2: any } | { A3: any } | { A4: any } | { A5: any } | { A6: any } | { A7: any } | { A8: any } | { A9: any } | { A10: any } | { A11: any } | { A12: any } | { A13: any } | { A14: any } | string | Uint8Array, index: H256 | string | Uint8Array, hash: H256 | string | Uint8Array, vc: CorePrimitivesKeyAesOutput | { ciphertext?: any; aad?: any; nonce?: any } | string | Uint8Array, reqExtHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, CorePrimitivesAssertion, H256, H256, CorePrimitivesKeyAesOutput, H256]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;

...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    drop3: {
       ...
       **/
      BalanceSlashed: AugmentedEvent<ApiType, [who: AccountId32, amount: u128], { who: AccountId32, amount: u128 }>;
      /**
       ...
       **/
      RewardPoolProposed: AugmentedEvent<ApiType, [id: u64, name: Bytes, owner: AccountId32], { id: u64, name: Bytes, owner: AccountId32 }>;
      /**
       ...
       **/
      RewardPoolRemoved: AugmentedEvent<ApiType, [id: u64, name: Bytes, owner: AccountId32], { id: u64, name: Bytes, owner: AccountId32 }>;
      /**
    ...
    identityManagement: {
      ...
      IdentityLinked: AugmentedEvent<ApiType, [account: AccountId32, identity: CorePrimitivesKeyAesOutput, idGraph: CorePrimitivesKeyAesOutput, reqExtHash: H256], { account: AccountId32, identity: CorePrimitivesKeyAesOutput, idGraph: CorePrimitivesKeyAesOutput, reqExtHash: H256 }>;
      ...
      LinkIdentityFailed: AugmentedEvent<ApiType, [account: Option<AccountId32>, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256], { account: Option<AccountId32>, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256 }>;

...
export interface TrustedCall extends Enum {
  ...
  readonly asLinkIdentity: ITuple<[AccountId, AccountId, LitentryIdentity, LitentryValidationData, UserShieldingKeyNonceType, H256]>;
  ...
  readonly type: 'BalanceSetBalance' | 'BalanceTransfer' | 'BalanceUnshield' | 'BalanceShield' | 'SetUserShieldingKey' | 'LinkIdentity' | 'RemoveIdentity' | 'RequestVc';
}

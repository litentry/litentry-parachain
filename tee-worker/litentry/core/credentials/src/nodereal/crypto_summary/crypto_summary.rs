...
pub const CRYPTO_SUMMARY_NFT_ADDRESSES_ETH_NFT: [(&str, &str); 15] = [
...
pub trait CryptoSummaryCredentialUpdate {
	fn update_crypto_summary_credential(&mut self, is_empty: bool);
}

impl CryptoSummaryCredentialUpdate for Credential {
	fn update_crypto_summary_credential(&mut self, _is_empty: bool) {

    ...
    interface AugmentedQueries<ApiType extends ApiTypes> {
        ...
        claims: {
            claims: AugmentedQuery<
                ApiType,
                (arg: ClaimsPrimitivesEthereumAddress | string | Uint8Array) => Observable<Option<u128>>,
                [ClaimsPrimitivesEthereumAddress]
            > &
                QueryableStorageEntry<ApiType, [ClaimsPrimitivesEthereumAddress]>;
            /**
             * Pre-claimed Ethereum accounts, by the Account ID that they are claimed to.
             **/
            preclaims: AugmentedQuery<
                ApiType,
                (arg: AccountId32 | string | Uint8Array) => Observable<Option<ClaimsPrimitivesEthereumAddress>>,
                [AccountId32]
            > &
                QueryableStorageEntry<ApiType, [AccountId32]>;
            /**
            ...
            signing: AugmentedQuery<
                ApiType,
                (
                    arg: ClaimsPrimitivesEthereumAddress | string | Uint8Array
                ) => Observable<Option<ClaimsPrimitivesStatementKind>>,
                [ClaimsPrimitivesEthereumAddress]
            > &
                QueryableStorageEntry<ApiType, [ClaimsPrimitivesEthereumAddress]>;
        ...
        teeracle: {
            ...
            exchangeRates: AugmentedQuery<
                ApiType,
                (arg1: Text | string, arg2: Text | string) => Observable<SubstrateFixedFixedU64>,
                [Text, Text]
            > &
                QueryableStorageEntry<ApiType, [Text, Text]>;
            oracleData: AugmentedQuery<
                ApiType,
                (arg1: Text | string, arg2: Text | string) => Observable<Bytes>,
                [Text, Text]
            > &
                QueryableStorageEntry<ApiType, [Text, Text]>;
            /**
             ...
             **/
            whitelists: AugmentedQuery<ApiType, (arg: Text | string) => Observable<Vec<U8aFixed>>, [Text]> &

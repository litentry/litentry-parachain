...
export type { Assertion, LitentryIdentity, LitentryValidationData, Web3Network, WorkerRpcReturnValue, TrustedCallSigned, Getter, PublicGetter, RequestVCResult, StfError, LinkIdentityResult, SetUserShieldingKeyResult, } from "../build/interfaces";

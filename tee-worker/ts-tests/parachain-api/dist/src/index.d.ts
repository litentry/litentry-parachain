...
export type { Assertion, LitentryIdentity, LitentryValidationData, Web3Network, WorkerRpcReturnValue, TrustedCallSigned, Getter, RequestVCResult, TrustedOperationResponse, StfError, LinkIdentityResult, } from "../build/interfaces";

...
import type { ActivateIdentityResult, Address20, Address32, AesOutput, Assertion, BoundedWeb3Network, DeactivateIdentityResult, DirectRequestStatus, DiscordValidationData, ErrorDetail, GenericEventWithAccount, Getter, IdentityContext, IdentityGenericEvent, IdentityStatus, IdentityString, LinkIdentityResult, LitentryIdentity, LitentryMultiSignature, LitentryValidationData, PublicGetter, Request, RequestVCResult, SetUserShieldingKeyResult, ShardIdentifier, StfError, TrustedCall, TrustedCallSigned, TrustedGetter, TrustedGetterSigned, TrustedOperation, TrustedOperationResponse, TrustedOperationStatus, TwitterValidationData, UserShieldingKeyNonceType, UserShieldingKeyType, VCRequested, Web2ValidationData, Web3CommonValidationData, Web3Network, Web3ValidationData, WorkerRpcReturnValue } from "parachain-api/interfaces/identity";

...
declare module '@polkadot/api-base/types/submittable' {
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
        ...
        identityManagement: {
             ...
             * an initial list of web3networks on which the identity is used:
             * Vec<Web3Network> encrypted TEE's shielding key
             * For web2 identities this value will be ignored.
             *
             * `nonce`:
             * A salt to calculate and verify the validation_data, needs to be
             * randomly generated by the caller. Not necessarily encrypted but

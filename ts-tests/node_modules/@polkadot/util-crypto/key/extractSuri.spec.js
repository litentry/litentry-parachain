...
describe('keyExtractSuri', () => {
  it('does not extract from invalid suri', () => {
    expect(() => (0, _extractSuri.keyExtractSuri)('//2')).toThrow('Unable to match provided value to a secret URI');
  });
  it('derives on "hello world"', () => {
    const test = (0, _extractSuri.keyExtractSuri)('hello world');
    expect(test.phrase).toEqual('hello world');
    expect(test.path.length).toEqual(0);
  });
  it('derives on "hello world/1', () => {
    const test = (0, _extractSuri.keyExtractSuri)('hello world/1');
  ...
  it('derives on "hello world/DOT', () => {
    const test = (0, _extractSuri.keyExtractSuri)('hello world/DOT');
    expect(test.password).not.toBeDefined();
    expect(test.phrase).toEqual('hello world');
    expect(test.path.length).toEqual(1);
    expect(test.path[0].isHard).toEqual(false);
  ...
  it('derives on "hello world//1/DOT', () => {
    const test = (0, _extractSuri.keyExtractSuri)('hello world//1/DOT');
    expect(test.password).not.toBeDefined();
    expect(test.phrase).toEqual('hello world');
  ...
  it('derives on "hello world//DOT/1', () => {
    const test = (0, _extractSuri.keyExtractSuri)('hello world//DOT/1');
    expect(test.password).not.toBeDefined();
    expect(test.phrase).toEqual('hello world');
    expect(test.path.length).toEqual(2);
    expect(test.path[0].isHard).toEqual(true);
  ...
  it('derives on "hello world///password"', () => {
    const test = (0, _extractSuri.keyExtractSuri)('hello world///password');
    expect(test.password).toEqual('password');
    expect(test.phrase).toEqual('hello world');
    expect(test.path.length).toEqual(0);
  });
  it('derives on "hello world//1/DOT///password"', () => {
    const test = (0, _extractSuri.keyExtractSuri)('hello world//1/DOT///password');
    expect(test.password).toEqual('password');
    expect(test.phrase).toEqual('hello world');
    expect(test.path.length).toEqual(2);
    expect(test.path[0].isHard).toEqual(true);
  ...
  it('derives on actual Alice', () => {
    const test = (0, _extractSuri.keyExtractSuri)('bottom drive obey lake curtain smoke basket hold race lonely fit walk//Alice');
    expect(test.password).not.toBeDefined();

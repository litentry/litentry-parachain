...
const MUL_ET = (0, _util.u8aToHex)((0, _util.u8aConcat)(new Uint8Array([2]), (0, _util.hexToU8a)(SIG_ET)));
describe('signatureVerify', () => {
  ...
  describe('verifyDetect', () => {
    ...
    it('verifies an ethereum signature', () => {
      expect((0, _.signatureVerify)(MESSAGE, SIG_ET, ADDR_ET)).toEqual({
        crypto: 'ethereum',
        isValid: true
      });
    });
    it('verifies an ethereum signature (known)', () => {
      const message = 'Pay KSMs to the Kusama account:88dc3417d5058ec4b4503e0c12ea1a0a89be200fe98922423d4334014fa6b0ee';
      expect((0, _.signatureVerify)(`\x19Ethereum Signed Message:\n${message.length.toString()}${message}`, '0x55bd020bdbbdc02de34e915effc9b18a99002f4c29f64e22e8dcbb69e722ea6c28e1bb53b9484063fbbfd205e49dcc1f620929f520c9c4c3695150f05a28f52a01', '0x002309df96687e44280bb72c3818358faeeb699c')).toEqual({
        crypto: 'ethereum',
        isValid: true
      });
    });
    it('fails on invalid ethereum signature', () => {
      expect((0, _.signatureVerify)(MESSAGE, SIG_EC, ADDR_ET)).toEqual({
        crypto: 'none',
        isValid: false
      });
    });
  ...
  describe('verifyMultisig', () => {
    ...
    it('verifies an ethereum signature', () => {
      expect((0, _.signatureVerify)(MESSAGE, MUL_ET, ADDR_ET)).toEqual({
        crypto: 'ethereum',
        isValid: true
      });
    });

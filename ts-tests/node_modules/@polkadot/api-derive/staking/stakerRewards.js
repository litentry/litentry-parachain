...
function filterRewards(api, eras, {
  ...
  return ((0, _util.isFunction)(api.tx.staking.payoutStakers) ? api.derive.staking.queryMulti(validators, {
    withLedger: true
  }) : (0, _rxjs.of)([])).pipe((0, _operators.map)(queryValidators => rewards.filter(({
    isEmpty
...
function _stakerRewards(instanceId, api) {
  return (0, _util2.memo)(instanceId, (accountId, eras, withActive) => (0, _rxjs.combineLatest)([api.derive.staking.query(accountId, {
    withLedger: true

...
// Litentry: We do not need runtime upgrade for now
// pub mod migrations;
...
pub mod pallet {
	...
	use frame_support::traits::{Currency, EstimateNextSessionRotation, Get, Imbalance, ReservableCurrency};
	...
	use sp_runtime::{
		...
		Permill, Perbill, Percent, RuntimeDebug,
	};
	...
	// Litentry: Adpation for traditional substrate authorship system

...
impl<T: frame_system::Config> pallet_bridge_transfer::WeightInfo for WeightInfo<T> {
	...
	fn transfer_native() -> Weight {
		// Minimum execution time: 104_146 nanoseconds.
		Weight::from_ref_time(106_978_000 as u64)
	...
	fn transfer() -> Weight {
		...
		Weight::from_ref_time(53_520_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: BridgeTransfer MaximumIssuance (r:1 w:1)
	fn set_maximum_issuance() -> Weight {
		// Minimum execution time: 25_045 nanoseconds.
		Weight::from_ref_time(25_610_000 as u64)
	...
	fn set_external_balances() -> Weight {
		...
		Weight::from_ref_time(7_737_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

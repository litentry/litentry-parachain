...
impl<T: frame_system::Config> pallet_bridge_transfer::WeightInfo for WeightInfo<T> {
	...
	fn transfer_native() -> Weight {
		// Minimum execution time: 76_524 nanoseconds.
		Weight::from_ref_time(79_278_000)
	...
	fn transfer() -> Weight {
		// Minimum execution time: 44_390 nanoseconds.
	...
	fn set_maximum_issuance() -> Weight {
		...
		Weight::from_ref_time(21_738_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: BridgeTransfer ExternalBalances (r:0 w:1)
	fn set_external_balances() -> Weight {
		// Minimum execution time: 5_924 nanoseconds.
		Weight::from_ref_time(6_113_000)
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_parts(18_922_891, 0)
			.saturating_add(Weight::from_parts(0, 3574))
			// Standard Error: 94
			.saturating_add(Weight::from_parts(4_580, 0).saturating_mul(p.into()))
			// Standard Error: 94
			.saturating_add(Weight::from_parts(4_452, 0).saturating_mul(f.into()))

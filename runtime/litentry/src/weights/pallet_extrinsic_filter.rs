...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		//  Measured:  `109`
		//  Estimated: `2584`
		// Minimum execution time: 21_435 nanoseconds.
		Weight::from_ref_time(18_747_225)
			.saturating_add(Weight::from_proof_size(2584))
			// Standard Error: 109
			.saturating_add(Weight::from_ref_time(4_245).saturating_mul(p.into()))
			// Standard Error: 109
			.saturating_add(Weight::from_ref_time(4_050).saturating_mul(f.into()))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		// Minimum execution time: 39_408 nanoseconds.
		Weight::from_ref_time(21_993_969)
			.saturating_add(Weight::from_proof_size(2621))
			// Standard Error: 292
			.saturating_add(Weight::from_ref_time(20_032).saturating_mul(p.into()))
			// Standard Error: 292
			.saturating_add(Weight::from_ref_time(19_379).saturating_mul(f.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))

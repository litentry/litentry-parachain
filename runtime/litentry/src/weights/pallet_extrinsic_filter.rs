...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(20_458_888)
			.saturating_add(Weight::from_proof_size(2584))
			// Standard Error: 67
			.saturating_add(Weight::from_ref_time(3_411).saturating_mul(p.into()))
			// Standard Error: 67
			.saturating_add(Weight::from_ref_time(3_663).saturating_mul(f.into()))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		// Minimum execution time: 39_305 nanoseconds.
		Weight::from_ref_time(20_921_982)
			.saturating_add(Weight::from_proof_size(2621))
			// Standard Error: 168
			.saturating_add(Weight::from_ref_time(19_629).saturating_mul(p.into()))
			// Standard Error: 168
			.saturating_add(Weight::from_ref_time(19_855).saturating_mul(f.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))

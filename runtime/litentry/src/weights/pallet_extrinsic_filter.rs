...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_parts(26_091_211, 0)
			.saturating_add(Weight::from_parts(0, 3574))
			// Standard Error: 48
			.saturating_add(Weight::from_parts(4_337, 0).saturating_mul(p.into()))
			// Standard Error: 48
			.saturating_add(Weight::from_parts(4_077, 0).saturating_mul(f.into()))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `145 + f * (1 ±0) + p * (1 ±0)`
		//  Estimated: `3611 + f * (1 ±0) + p * (1 ±0)`
		// Minimum execution time: 46_566_000 picoseconds.
		Weight::from_parts(30_796_558, 0)
			.saturating_add(Weight::from_parts(0, 3611))
			// Standard Error: 45
			.saturating_add(Weight::from_parts(16_761, 0).saturating_mul(p.into()))
			// Standard Error: 45
			.saturating_add(Weight::from_parts(16_652, 0).saturating_mul(f.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))

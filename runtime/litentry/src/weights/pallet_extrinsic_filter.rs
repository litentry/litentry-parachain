...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		Weight::from_ref_time(34_845_000 as u64)
			// Standard Error: 41
			.saturating_add(Weight::from_ref_time(2_382 as u64).saturating_mul(p as u64))
			// Standard Error: 41
			.saturating_add(Weight::from_ref_time(2_165 as u64).saturating_mul(f as u64))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		Weight::from_ref_time(50_701_000 as u64)
			// Standard Error: 181
			.saturating_add(Weight::from_ref_time(6_983 as u64).saturating_mul(p as u64))
			// Standard Error: 181
			.saturating_add(Weight::from_ref_time(7_087 as u64).saturating_mul(f as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

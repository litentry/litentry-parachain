...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		// Minimum execution time: 35_868 nanoseconds.
		Weight::from_ref_time(33_782_140 as u64)
			// Standard Error: 44
			.saturating_add(Weight::from_ref_time(3_460 as u64).saturating_mul(p as u64))
			// Standard Error: 44
			.saturating_add(Weight::from_ref_time(3_504 as u64).saturating_mul(f as u64))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		// Minimum execution time: 54_070 nanoseconds.
		Weight::from_ref_time(37_073_718 as u64)
			// Standard Error: 63
			.saturating_add(Weight::from_ref_time(18_502 as u64).saturating_mul(p as u64))
			// Standard Error: 63
			.saturating_add(Weight::from_ref_time(18_577 as u64).saturating_mul(f as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

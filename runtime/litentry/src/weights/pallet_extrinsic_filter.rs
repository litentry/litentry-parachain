...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(30_447_379 as u64)
			// Standard Error: 58
			.saturating_add(Weight::from_ref_time(4_136 as u64).saturating_mul(p as u64))
			// Standard Error: 58
			.saturating_add(Weight::from_ref_time(3_975 as u64).saturating_mul(f as u64))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		// Minimum execution time: 51_281 nanoseconds.
		Weight::from_ref_time(33_398_545 as u64)
			// Standard Error: 61
			.saturating_add(Weight::from_ref_time(19_351 as u64).saturating_mul(p as u64))
			// Standard Error: 61
			.saturating_add(Weight::from_ref_time(19_758 as u64).saturating_mul(f as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

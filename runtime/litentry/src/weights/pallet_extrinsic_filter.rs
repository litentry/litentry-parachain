...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		Weight::from_ref_time(32_686_000 as u64)
			// Standard Error: 44
			.saturating_add(Weight::from_ref_time(2_606 as u64).saturating_mul(p as u64))
			// Standard Error: 44
			.saturating_add(Weight::from_ref_time(2_216 as u64).saturating_mul(f as u64))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		Weight::from_ref_time(48_900_000 as u64)
			// Standard Error: 208
			.saturating_add(Weight::from_ref_time(7_419 as u64).saturating_mul(p as u64))
			// Standard Error: 208
			.saturating_add(Weight::from_ref_time(7_100 as u64).saturating_mul(f as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

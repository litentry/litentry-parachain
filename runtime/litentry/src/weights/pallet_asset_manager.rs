...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for WeightInfo<T> {
	...
	fn register_foreign_asset_type() -> Weight {
		...
		//  Measured:  `109`
		//  Estimated: `3406`
		// Minimum execution time: 33_564 nanoseconds.
	...
	fn update_foreign_asset_metadata() -> Weight {
		...
		//  Measured:  `269`
		//  Estimated: `3013`
		// Minimum execution time: 20_566 nanoseconds.
		Weight::from_ref_time(21_382_000)
	...
	fn set_asset_units_per_second() -> Weight {
		...
		Weight::from_ref_time(20_373_000)
			.saturating_add(Weight::from_proof_size(3013))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn add_asset_type() -> Weight {
		...
		Weight::from_ref_time(25_629_000)
	...
	fn remove_asset_type() -> Weight {
		...
		//  Measured:  `449`
		//  Estimated: `5848`
		// Minimum execution time: 31_804 nanoseconds.
		Weight::from_ref_time(32_382_000)

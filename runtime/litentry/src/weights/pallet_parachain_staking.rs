...
impl<T: frame_system::Config> pallet_parachain_staking::WeightInfo for WeightInfo<T> {
	...
	fn add_candidates_whitelist(x: u32, ) -> Weight {
		Weight::from_ref_time(27_232_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(543_371 as u64).saturating_mul(x as u64))
	...
	fn remove_candidates_whitelist(x: u32, ) -> Weight {
		Weight::from_ref_time(26_500_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(574_504 as u64).saturating_mul(x as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn set_inflation() -> Weight {
		Weight::from_ref_time(89_406_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: ParachainStaking ParachainBondInfo (r:1 w:1)
	fn set_parachain_bond_account() -> Weight {
		Weight::from_ref_time(29_748_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: ParachainStaking ParachainBondInfo (r:1 w:1)
	fn set_parachain_bond_reserve_percent() -> Weight {
		Weight::from_ref_time(27_478_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn set_total_selected() -> Weight {
		Weight::from_ref_time(27_753_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn set_blocks_per_round() -> Weight {
		Weight::from_ref_time(36_658_000 as u64)
	...
	fn join_candidates(x: u32, ) -> Weight {
		Weight::from_ref_time(72_127_000 as u64)
			// Standard Error: 1_860
			.saturating_add(Weight::from_ref_time(402_412 as u64).saturating_mul(x as u64))
	...
	fn schedule_leave_candidates(x: u32, ) -> Weight {
		Weight::from_ref_time(46_416_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(346_765 as u64).saturating_mul(x as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: ParachainStaking CandidateInfo (r:1 w:1)
	...
	fn execute_leave_candidates(x: u32, ) -> Weight {
		Weight::from_ref_time(160_179_000 as u64)
			// Standard Error: 472_547
			.saturating_add(Weight::from_ref_time(58_133_456 as u64).saturating_mul(x as u64))
	...
	fn cancel_leave_candidates(x: u32, ) -> Weight {
		Weight::from_ref_time(42_966_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(378_709 as u64).saturating_mul(x as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: ParachainStaking CandidateInfo (r:1 w:1)
	...
	fn go_offline() -> Weight {
		Weight::from_ref_time(39_321_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: ParachainStaking CandidateInfo (r:1 w:1)
	// Storage: ParachainStaking CandidatePool (r:1 w:1)
	fn go_online() -> Weight {
		Weight::from_ref_time(39_005_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: ParachainStaking CandidateInfo (r:1 w:1)
	...
	fn candidate_bond_more() -> Weight {
		Weight::from_ref_time(61_734_000 as u64)
	...
	fn execute_candidate_bond_less() -> Weight {
		Weight::from_ref_time(110_709_000 as u64)
			.saturating_add(T::DbWeight::get().reads(5 as u64))
			.saturating_add(T::DbWeight::get().writes(4 as u64))
	}
	// Storage: ParachainStaking CandidateInfo (r:1 w:1)
	fn cancel_candidate_bond_less() -> Weight {
		Weight::from_ref_time(34_012_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: ParachainStaking DelegatorState (r:1 w:1)
	...
	fn execute_leave_delegators(x: u32, ) -> Weight {
		Weight::from_ref_time(141_328_000 as u64)
			// Standard Error: 85_997
			.saturating_add(Weight::from_ref_time(40_544_111 as u64).saturating_mul(x as u64))
	...
	fn cancel_leave_delegators() -> Weight {
		Weight::from_ref_time(46_096_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: ParachainStaking DelegatorState (r:1 w:1)
	...
	fn schedule_revoke_delegation() -> Weight {
		Weight::from_ref_time(43_753_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	...
	fn execute_revoke_delegation() -> Weight {
		Weight::from_ref_time(156_714_000 as u64)
			.saturating_add(T::DbWeight::get().reads(9 as u64))
			.saturating_add(T::DbWeight::get().writes(7 as u64))
	}
	// Storage: ParachainStaking DelegatorState (r:1 w:1)
	...
	fn execute_delegator_bond_less() -> Weight {
		Weight::from_ref_time(135_337_000 as u64)
	...
	fn cancel_revoke_delegation() -> Weight {
		Weight::from_ref_time(47_788_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: ParachainStaking DelegatorState (r:1 w:1)
	...
	fn cancel_delegator_bond_less() -> Weight {
		Weight::from_ref_time(83_585_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: ParachainStaking Round (r:1 w:1)
	...
	fn round_transition_on_initialize(x: u32, y: u32, ) -> Weight {
		Weight::from_ref_time(1_338_965_000 as u64)
			// Standard Error: 2_094_777
			.saturating_add(Weight::from_ref_time(3_924_927 as u64).saturating_mul(x as u64))
			// Standard Error: 42_264
			.saturating_add(Weight::from_ref_time(293_535 as u64).saturating_mul(y as u64))
	...
	fn pay_one_collator_reward(y: u32, ) -> Weight {
		Weight::from_ref_time(67_994_000 as u64)
			// Standard Error: 56_494
			.saturating_add(Weight::from_ref_time(18_722_014 as u64).saturating_mul(y as u64))
			.saturating_add(T::DbWeight::get().reads(6 as u64))

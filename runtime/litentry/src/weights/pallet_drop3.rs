...
impl<T: frame_system::Config> pallet_drop3::WeightInfo for WeightInfo<T> {
	...
	fn approve_reward_pool() -> Weight {
		Weight::from_ref_time(36_580_000 as u64)
	...
	fn stop_reward_pool() -> Weight {
		Weight::from_ref_time(39_495_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Drop3 RewardPools (r:1 w:1)
	...
	fn close_reward_pool() -> Weight {
		Weight::from_ref_time(64_096_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: System Account (r:1 w:1)
	...
	fn propose_reward_pool(n: u32, ) -> Weight {
		Weight::from_ref_time(54_980_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(73_282 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	...
	fn send_reward() -> Weight {
		Weight::from_ref_time(66_967_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
}

...
impl<T: frame_system::Config> pallet_drop3::WeightInfo for WeightInfo<T> {
	...
	fn set_admin() -> Weight {
		...
		Weight::from_ref_time(12_848_000)
	...
	fn approve_reward_pool() -> Weight {
		...
		Weight::from_ref_time(22_992_000)
	...
	fn reject_reward_pool() -> Weight {
		...
		//  Measured:  `429`
		//  Estimated: `6860`
		// Minimum execution time: 65_282 nanoseconds.
		Weight::from_ref_time(66_637_000)
	...
	fn start_reward_pool() -> Weight {
		...
		//  Measured:  `296`
		//  Estimated: `3562`
		// Minimum execution time: 22_675 nanoseconds.
		Weight::from_ref_time(23_450_000)
			.saturating_add(Weight::from_proof_size(3562))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn stop_reward_pool() -> Weight {
		...
		Weight::from_ref_time(23_119_000)
			.saturating_add(Weight::from_proof_size(3562))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn close_reward_pool() -> Weight {
		...
		//  Measured:  `429`
		//  Estimated: `6860`
		// Minimum execution time: 40_896 nanoseconds.
		Weight::from_ref_time(41_824_000)
			.saturating_add(Weight::from_proof_size(6860))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	...
	fn propose_reward_pool(n: u32, ) -> Weight {
		...
		//  Measured:  `137`
		//  Estimated: `3509`
		// Minimum execution time: 37_226 nanoseconds.
		Weight::from_ref_time(38_454_760)
			.saturating_add(Weight::from_proof_size(3509))
			// Standard Error: 9_660
			.saturating_add(Weight::from_ref_time(113_453).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn send_reward() -> Weight {
		...
		//  Measured:  `545`
		//  Estimated: `8226`
		// Minimum execution time: 43_885 nanoseconds.
		Weight::from_ref_time(46_285_000)

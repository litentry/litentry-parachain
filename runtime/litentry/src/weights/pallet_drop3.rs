...
impl<T: frame_system::Config> pallet_drop3::WeightInfo for WeightInfo<T> {
	...
	fn set_admin() -> Weight {
		...
		Weight::from_ref_time(23_314_000)
	...
	fn approve_reward_pool() -> Weight {
		...
		Weight::from_ref_time(32_359_000)
	...
	fn reject_reward_pool() -> Weight {
		// Minimum execution time: 73_296 nanoseconds.
		Weight::from_ref_time(74_455_000)
	...
	fn start_reward_pool() -> Weight {
		// Minimum execution time: 31_916 nanoseconds.
		Weight::from_ref_time(32_559_000)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: Drop3 RewardPools (r:1 w:1)
	...
	fn stop_reward_pool() -> Weight {
		...
		Weight::from_ref_time(34_298_000)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: Drop3 RewardPools (r:1 w:1)
	...
	fn close_reward_pool() -> Weight {
		// Minimum execution time: 53_116 nanoseconds.
		Weight::from_ref_time(54_015_000)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	// Storage: System Account (r:1 w:1)
	...
	fn propose_reward_pool(_n: u32, ) -> Weight {
		// Minimum execution time: 44_560 nanoseconds.
		Weight::from_ref_time(47_196_510)
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn send_reward() -> Weight {
		...
		Weight::from_ref_time(56_109_000)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
}

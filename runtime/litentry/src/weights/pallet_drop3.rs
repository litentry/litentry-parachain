...
impl<T: frame_system::Config> pallet_drop3::WeightInfo for WeightInfo<T> {
	...
	fn set_admin() -> Weight {
		// Minimum execution time: 23_596 nanoseconds.
		Weight::from_ref_time(24_410_000 as u64)
	...
	fn approve_reward_pool() -> Weight {
		...
		Weight::from_ref_time(34_303_000 as u64)
	...
	fn reject_reward_pool() -> Weight {
		...
		Weight::from_ref_time(82_269_000 as u64)
	...
	fn start_reward_pool() -> Weight {
		...
		Weight::from_ref_time(34_236_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Drop3 RewardPools (r:1 w:1)
	...
	fn close_reward_pool() -> Weight {
		...
		Weight::from_ref_time(58_066_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: System Account (r:1 w:1)
	...
	fn propose_reward_pool(n: u32, ) -> Weight {
		// Minimum execution time: 48_115 nanoseconds.
		Weight::from_ref_time(49_785_514 as u64)
			// Standard Error: 6_892
			.saturating_add(Weight::from_ref_time(38_843 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	...
	fn send_reward() -> Weight {
		// Minimum execution time: 59_032 nanoseconds.
		Weight::from_ref_time(60_632_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
}

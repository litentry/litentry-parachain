...
impl<T: frame_system::Config> pallet_bridge::WeightInfo for WeightInfo<T> {
	...
	fn set_threshold() -> Weight {
		Weight::from_ref_time(18_715_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: ChainBridge Resources (r:0 w:1)
	fn set_resource() -> Weight {
		Weight::from_ref_time(7_601_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: ChainBridge Resources (r:0 w:1)
	...
	fn add_relayer() -> Weight {
		Weight::from_ref_time(27_370_000 as u64)
	...
	fn remove_relayer() -> Weight {
		Weight::from_ref_time(29_296_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	...
	fn acknowledge_proposal() -> Weight {
		Weight::from_ref_time(61_730_000 as u64)
	...
	fn reject_proposal() -> Weight {
		Weight::from_ref_time(54_155_000 as u64)
			.saturating_add(T::DbWeight::get().reads(6 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: ChainBridge Votes (r:1 w:1)
	...
	fn eval_vote_state() -> Weight {
		Weight::from_ref_time(26_533_000 as u64)

...
impl<T: frame_system::Config> pallet_teerex::WeightInfo for WeightInfo<T> {
	...
	fn register_enclave() -> Weight {
		...
		//  Measured:  `451`
		//  Estimated: `10227`
		// Minimum execution time: 2_118_687 nanoseconds.
		Weight::from_ref_time(2_210_334_000)
	...
	fn unregister_enclave() -> Weight {
		...
		Weight::from_ref_time(42_620_000)
	...
	fn call_worker() -> Weight {
		...
		Weight::from_ref_time(14_061_000)
	...
	fn confirm_processed_parentchain_block() -> Weight {
		...
		Weight::from_ref_time(38_871_000)
	...
	fn publish_hash(_l: u32, t: u32, ) -> Weight {
		...
		// Minimum execution time: 32_965 nanoseconds.
		Weight::from_ref_time(32_423_077)
			.saturating_add(Weight::from_proof_size(8526))
			// Standard Error: 13_805
			.saturating_add(Weight::from_ref_time(2_639_716).saturating_mul(t.into()))
			.saturating_add(T::DbWeight::get().reads(3))

...
impl<T: frame_system::Config> pallet_teerex::WeightInfo for WeightInfo<T> {
	...
	fn register_enclave() -> Weight {
		// Minimum execution time: 1_952_813 nanoseconds.
		Weight::from_ref_time(1_972_304_000 as u64)
	...
	fn unregister_enclave() -> Weight {
		// Minimum execution time: 46_829 nanoseconds.
		Weight::from_ref_time(47_719_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(5 as u64))
	}
	fn call_worker() -> Weight {
		// Minimum execution time: 22_158 nanoseconds.
		Weight::from_ref_time(22_988_000 as u64)
	}
	// Storage: Teerex EnclaveIndex (r:1 w:0)
	fn confirm_processed_parentchain_block() -> Weight {
		// Minimum execution time: 28_538 nanoseconds.

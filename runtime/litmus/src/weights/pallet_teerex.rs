...
impl<T: frame_system::Config> pallet_teerex::WeightInfo for WeightInfo<T> {
	...
	fn register_enclave() -> Weight {
		...
		//  Measured:  `451`
		//  Estimated: `10227`
		// Minimum execution time: 2_120_036 nanoseconds.
		Weight::from_ref_time(2_141_297_000)
	...
	fn unregister_enclave() -> Weight {
		...
		//  Measured:  `509`
		//  Estimated: `6972`
		// Minimum execution time: 43_541 nanoseconds.
		Weight::from_ref_time(45_008_000)
	...
	fn call_worker() -> Weight {
		...
		Weight::from_ref_time(14_128_000)
	...
	fn confirm_processed_parentchain_block() -> Weight {
		...
		//  Measured:  `409`
		//  Estimated: `6271`
		// Minimum execution time: 39_211 nanoseconds.
		Weight::from_ref_time(41_054_000)
	...
	fn publish_hash(l: u32, t: u32, ) -> Weight {
		...
		Weight::from_ref_time(29_876_236)
			.saturating_add(Weight::from_proof_size(8526))
			// Standard Error: 1_535
			.saturating_add(Weight::from_ref_time(26_878).saturating_mul(l.into()))
			// Standard Error: 34_259
			.saturating_add(Weight::from_ref_time(3_016_675).saturating_mul(t.into()))
			.saturating_add(T::DbWeight::get().reads(3))

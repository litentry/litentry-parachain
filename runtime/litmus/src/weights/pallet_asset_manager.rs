...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for WeightInfo<T> {
	...
	fn register_foreign_asset_type() -> Weight {
		// Minimum execution time: 47_433 nanoseconds.
		Weight::from_ref_time(48_079_000 as u64)
	...
	fn update_foreign_asset_metadata() -> Weight {
		...
		Weight::from_ref_time(32_778_000 as u64)
	...
	fn set_asset_units_per_second() -> Weight {
		...
		Weight::from_ref_time(31_698_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn add_asset_type() -> Weight {
		// Minimum execution time: 37_566 nanoseconds.
	...
	fn remove_asset_type() -> Weight {
		// Minimum execution time: 46_249 nanoseconds.
		Weight::from_ref_time(47_449_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
}

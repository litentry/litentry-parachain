...
impl<T: frame_system::Config> pallet_drop3::WeightInfo for WeightInfo<T> {
	...
	fn set_admin() -> Weight {
		...
		Weight::from_ref_time(24_669_000 as u64)
	...
	fn reject_reward_pool() -> Weight {
		// Minimum execution time: 81_182 nanoseconds.
		Weight::from_ref_time(82_150_000 as u64)
	...
	fn start_reward_pool() -> Weight {
		...
		Weight::from_ref_time(34_400_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Drop3 RewardPools (r:1 w:1)
	...
	fn close_reward_pool() -> Weight {
		// Minimum execution time: 56_955 nanoseconds.
		Weight::from_ref_time(58_432_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: System Account (r:1 w:1)
	...
	fn propose_reward_pool(n: u32, ) -> Weight {
		// Minimum execution time: 48_051 nanoseconds.
		Weight::from_ref_time(49_624_317 as u64)
			// Standard Error: 4_002
			.saturating_add(Weight::from_ref_time(38_364 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	...
	fn send_reward() -> Weight {
		...
		Weight::from_ref_time(60_986_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
}

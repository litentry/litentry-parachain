...
impl<T: frame_system::Config> pallet_drop3::WeightInfo for WeightInfo<T> {
	...
	fn set_admin() -> Weight {
		// Minimum execution time: 27_093 nanoseconds.
		Weight::from_ref_time(27_676_000 as u64)
	...
	fn approve_reward_pool() -> Weight {
		...
		Weight::from_ref_time(37_702_000 as u64)
	...
	fn reject_reward_pool() -> Weight {
		// Minimum execution time: 95_446 nanoseconds.
		Weight::from_ref_time(96_234_000 as u64)
	...
	fn start_reward_pool() -> Weight {
		...
		Weight::from_ref_time(37_897_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Drop3 RewardPools (r:1 w:1)
	...
	fn stop_reward_pool() -> Weight {
		// Minimum execution time: 40_159 nanoseconds.
	...
	fn close_reward_pool() -> Weight {
		// Minimum execution time: 64_449 nanoseconds.
		Weight::from_ref_time(66_331_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: System Account (r:1 w:1)
	...
	fn propose_reward_pool(n: u32, ) -> Weight {
		// Minimum execution time: 54_956 nanoseconds.
		Weight::from_ref_time(57_098_491 as u64)
			// Standard Error: 4_070
			.saturating_add(Weight::from_ref_time(18_279 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	...
	fn send_reward() -> Weight {
		// Minimum execution time: 68_337 nanoseconds.

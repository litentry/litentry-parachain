...
impl<T: frame_system::Config> pallet_drop3::WeightInfo for WeightInfo<T> {
	...
	fn approve_reward_pool() -> Weight {
		...
		//  Measured:  `296`
		//  Estimated: `3562`
		// Minimum execution time: 22_473 nanoseconds.
	...
	fn reject_reward_pool() -> Weight {
		...
		//  Measured:  `429`
		//  Estimated: `6860`
		// Minimum execution time: 66_830 nanoseconds.
		Weight::from_ref_time(67_659_000)
	...
	fn start_reward_pool() -> Weight {
		...
		//  Measured:  `296`
		//  Estimated: `3562`
		// Minimum execution time: 22_789 nanoseconds.
		Weight::from_ref_time(23_246_000)
			.saturating_add(Weight::from_proof_size(3562))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn stop_reward_pool() -> Weight {
		...
		Weight::from_ref_time(23_209_000)
			.saturating_add(Weight::from_proof_size(3562))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn close_reward_pool() -> Weight {
		...
		//  Measured:  `429`
		//  Estimated: `6860`
		// Minimum execution time: 41_617 nanoseconds.
		Weight::from_ref_time(42_651_000)
			.saturating_add(Weight::from_proof_size(6860))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	...
	fn propose_reward_pool(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(38_983_535)
			.saturating_add(Weight::from_proof_size(3509))
			// Standard Error: 7_342
			.saturating_add(Weight::from_ref_time(56_821).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn send_reward() -> Weight {
		...
		//  Measured:  `545`
		//  Estimated: `8226`
		// Minimum execution time: 43_725 nanoseconds.
		Weight::from_ref_time(45_842_000)

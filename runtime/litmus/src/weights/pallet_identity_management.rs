...
impl<T: frame_system::Config> pallet_identity_management::WeightInfo for WeightInfo<T> {
	...
	fn add_delegatee() -> Weight {
		...
		Weight::from_ref_time(12_287_000)
	...
	fn deactivate_identity() -> Weight {
		...
		//  Measured:  `76`
		//  Estimated: `571`
		// Minimum execution time: 15_402 nanoseconds.
	...
	fn identity_deactivated() -> Weight {
		...
		Weight::from_ref_time(20_624_000)
			.saturating_add(Weight::from_proof_size(2717))
			.saturating_add(T::DbWeight::get().reads(1))
	}
	/// Storage: Teerex EnclaveIndex (r:1 w:0)
	...
	fn identity_activated() -> Weight {
		...
		//  Measured:  `242`
		//  Estimated: `2717`
		// Minimum execution time: 20_250 nanoseconds.
		Weight::from_ref_time(21_449_000)
			.saturating_add(Weight::from_proof_size(2717))
			.saturating_add(T::DbWeight::get().reads(1))
	}
	/// Storage: Teerex EnclaveIndex (r:1 w:0)
	...
	fn some_error() -> Weight {
		...
		Weight::from_ref_time(20_891_000)
			.saturating_add(Weight::from_proof_size(2717))
			.saturating_add(T::DbWeight::get().reads(1))
	}
}

...
impl<T: frame_system::Config> pallet_bridge_transfer::WeightInfo for WeightInfo<T> {
	...
	fn transfer_native() -> Weight {
		// Minimum execution time: 104_517 nanoseconds.
		Weight::from_ref_time(105_814_000 as u64)
	...
	fn transfer() -> Weight {
		// Minimum execution time: 53_205 nanoseconds.
	...
	fn set_maximum_issuance() -> Weight {
		// Minimum execution time: 25_654 nanoseconds.
	...
	fn set_external_balances() -> Weight {
		...
		Weight::from_ref_time(7_921_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

...
impl<T: frame_system::Config> pallet_teeracle::WeightInfo for WeightInfo<T> {
	...
	fn update_exchange_rate() -> Weight {
		...
		Weight::from_ref_time(63_471_000 as u64)
	...
	fn update_oracle() -> Weight {
		// Minimum execution time: 55_735 nanoseconds.
		Weight::from_ref_time(57_466_000 as u64)
	...
	fn remove_from_whitelist() -> Weight {
		...
		Weight::from_ref_time(34_234_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(5_134_000 as u64)
			// Standard Error: 5
			.saturating_add(Weight::from_ref_time(653 as u64).saturating_mul(b as u64))
	}
	/// The range of component `b` is `[0, 3932160]`.
	fn remark_with_event(b: u32, ) -> Weight {
		// Minimum execution time: 18_825 nanoseconds.
		Weight::from_ref_time(95_905_617 as u64)
			// Standard Error: 15
	...
	fn set_heap_pages() -> Weight {
		...
		Weight::from_ref_time(11_939_000 as u64)
	...
	fn set_storage(i: u32, ) -> Weight {
		// Minimum execution time: 5_053 nanoseconds.
		Weight::from_ref_time(5_218_000 as u64)
			// Standard Error: 1_458
			.saturating_add(Weight::from_ref_time(959_939 as u64).saturating_mul(i as u64))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(5_196_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(846_465 as u64).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(7_390_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(1_915_552 as u64).saturating_mul(p as u64))

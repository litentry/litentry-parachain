...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(2_370_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 1
			.saturating_add(Weight::from_ref_time(571).saturating_mul(b.into()))
	}
	/// The range of component `b` is `[0, 3932160]`.
	fn remark_with_event(b: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 10_082 nanoseconds.
		Weight::from_ref_time(10_301_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 32
			.saturating_add(Weight::from_ref_time(3_012).saturating_mul(b.into()))
	}
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(2_931_000)
			...
			.saturating_add(Weight::from_ref_time(1_173_052).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(2_570_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 4_241
			.saturating_add(Weight::from_ref_time(816_231).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: Skipped Metadata (r:0 w:0)
	/// Proof Skipped: Skipped Metadata (max_values: None, max_size: None, mode: Measured)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		// Minimum execution time: 4_715 nanoseconds.
		Weight::from_ref_time(4_902_000)
			.saturating_add(Weight::from_proof_size(107))
			// Standard Error: 14_883
			.saturating_add(Weight::from_ref_time(1_947_925).saturating_mul(p.into()))

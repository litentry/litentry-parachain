...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		Weight::from_ref_time(34_965_000 as u64)
			// Standard Error: 43
			.saturating_add(Weight::from_ref_time(2_257 as u64).saturating_mul(p as u64))
			// Standard Error: 43
			.saturating_add(Weight::from_ref_time(2_270 as u64).saturating_mul(f as u64))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		Weight::from_ref_time(50_719_000 as u64)
			// Standard Error: 176
			.saturating_add(Weight::from_ref_time(7_094 as u64).saturating_mul(p as u64))
			// Standard Error: 176
			.saturating_add(Weight::from_ref_time(7_121 as u64).saturating_mul(f as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		// Minimum execution time: 31_918 nanoseconds.
		Weight::from_ref_time(30_369_230 as u64)
			// Standard Error: 70
			.saturating_add(Weight::from_ref_time(3_573 as u64).saturating_mul(p as u64))
			// Standard Error: 70
			.saturating_add(Weight::from_ref_time(3_706 as u64).saturating_mul(f as u64))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(34_086_606 as u64)
			// Standard Error: 226
			.saturating_add(Weight::from_ref_time(17_100 as u64).saturating_mul(p as u64))
			// Standard Error: 226
			.saturating_add(Weight::from_ref_time(16_190 as u64).saturating_mul(f as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(26_443_340)
			// Standard Error: 63
			.saturating_add(Weight::from_ref_time(4_107).saturating_mul(p.into()))
			// Standard Error: 63
			.saturating_add(Weight::from_ref_time(4_147).saturating_mul(f.into()))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		// Minimum execution time: 44_516 nanoseconds.
		Weight::from_ref_time(28_775_327)
			// Standard Error: 75
			.saturating_add(Weight::from_ref_time(17_210).saturating_mul(p.into()))
			// Standard Error: 75
			.saturating_add(Weight::from_ref_time(17_209).saturating_mul(f.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

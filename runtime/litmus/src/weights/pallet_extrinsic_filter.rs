...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		Weight::from_ref_time(32_266_000 as u64)
			// Standard Error: 37
			.saturating_add(Weight::from_ref_time(1_892 as u64).saturating_mul(p as u64))
			// Standard Error: 37
			.saturating_add(Weight::from_ref_time(2_034 as u64).saturating_mul(f as u64))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		Weight::from_ref_time(47_838_000 as u64)
			// Standard Error: 174
			.saturating_add(Weight::from_ref_time(7_476 as u64).saturating_mul(p as u64))
			// Standard Error: 174
			.saturating_add(Weight::from_ref_time(7_162 as u64).saturating_mul(f as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

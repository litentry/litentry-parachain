...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(19_865_602)
			.saturating_add(Weight::from_proof_size(2617))
			// Standard Error: 265
			.saturating_add(Weight::from_ref_time(4_733).saturating_mul(p.into()))
			// Standard Error: 265
			.saturating_add(Weight::from_ref_time(4_046).saturating_mul(f.into()))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(22_416_582)
			.saturating_add(Weight::from_proof_size(2654))
			// Standard Error: 388
			.saturating_add(Weight::from_ref_time(19_994).saturating_mul(p.into()))
			// Standard Error: 388
			.saturating_add(Weight::from_ref_time(20_491).saturating_mul(f.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))

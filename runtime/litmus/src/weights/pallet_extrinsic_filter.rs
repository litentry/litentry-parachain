...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_parts(20_094_208, 0)
			.saturating_add(Weight::from_parts(0, 3607))
			// Standard Error: 310
			.saturating_add(Weight::from_parts(3_958, 0).saturating_mul(p.into()))
			// Standard Error: 310
			.saturating_add(Weight::from_parts(4_487, 0).saturating_mul(f.into()))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_parts(21_283_826, 0)
			.saturating_add(Weight::from_parts(0, 3644))
			// Standard Error: 316
			.saturating_add(Weight::from_parts(14_221, 0).saturating_mul(p.into()))
			// Standard Error: 316
			.saturating_add(Weight::from_parts(14_333, 0).saturating_mul(f.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))

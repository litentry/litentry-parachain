...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(20_166_342)
			.saturating_add(Weight::from_proof_size(2617))
			// Standard Error: 56
			.saturating_add(Weight::from_ref_time(3_733).saturating_mul(p.into()))
			// Standard Error: 56
			.saturating_add(Weight::from_ref_time(3_591).saturating_mul(f.into()))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(21_913_463)
			.saturating_add(Weight::from_proof_size(2654))
			// Standard Error: 52
			.saturating_add(Weight::from_ref_time(18_488).saturating_mul(p.into()))
			// Standard Error: 52
			.saturating_add(Weight::from_ref_time(18_628).saturating_mul(f.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))

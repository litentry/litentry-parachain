...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		// Minimum execution time: 35_122 nanoseconds.
		Weight::from_ref_time(34_075_346 as u64)
			// Standard Error: 49
			.saturating_add(Weight::from_ref_time(3_589 as u64).saturating_mul(p as u64))
			// Standard Error: 49
			.saturating_add(Weight::from_ref_time(3_531 as u64).saturating_mul(f as u64))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		// Minimum execution time: 54_468 nanoseconds.
		Weight::from_ref_time(36_734_889 as u64)
			// Standard Error: 69
			.saturating_add(Weight::from_ref_time(18_840 as u64).saturating_mul(p as u64))
			// Standard Error: 69
			.saturating_add(Weight::from_ref_time(18_781 as u64).saturating_mul(f as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

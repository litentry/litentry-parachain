...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		// Minimum execution time: 31_757 nanoseconds.
		Weight::from_ref_time(30_965_107 as u64)
			// Standard Error: 82
			.saturating_add(Weight::from_ref_time(3_173 as u64).saturating_mul(p as u64))
			// Standard Error: 82
			.saturating_add(Weight::from_ref_time(3_132 as u64).saturating_mul(f as u64))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(32_584_305 as u64)
			// Standard Error: 75
			.saturating_add(Weight::from_ref_time(19_892 as u64).saturating_mul(p as u64))
			// Standard Error: 75
			.saturating_add(Weight::from_ref_time(19_601 as u64).saturating_mul(f as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

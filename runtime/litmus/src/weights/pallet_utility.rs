...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		Weight::from_ref_time(16_515_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(5_061_000 as u64).saturating_mul(c as u64))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		Weight::from_ref_time(12_782_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(5_269_000 as u64).saturating_mul(c as u64))
	}
	fn dispatch_as() -> Weight {
		Weight::from_ref_time(14_802_000 as u64)
	}
	/// The range of component `c` is `[0, 1000]`.
	fn force_batch(c: u32, ) -> Weight {
		Weight::from_ref_time(17_295_000 as u64)
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(5_057_000 as u64).saturating_mul(c as u64))
	}
}

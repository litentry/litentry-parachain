...
struct MoonbaseTestXCMRequirements;

impl TestXCMRequirements for MoonbaseTestXCMRequirements {
...
fn test_xtokens_recognize_multilocation() {
	xcm_parachain::test_xtokens_recognize_multilocation::<MoonbaseTestXCMRequirements>();
}

// If this test fail, at least some part of XCM fee rule changes
#[test]
fn test_xtokens_weight_parameter() {
	xcm_parachain::test_xtokens_weight_parameter::<MoonbaseTestXCMRequirements>();
}

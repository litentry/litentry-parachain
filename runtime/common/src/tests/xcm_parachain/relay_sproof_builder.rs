...
//! Inspired by:
//! - Cumulus `relay_sproof_builder`
//! implementations.

// Litentry modify this file to mimic HRMP Channel info
...
impl RelayStateSproofBuilder {
	...
	pub fn upsert_ingress_channel(&mut self, sender: ParaId) -> &mut AbridgedHrmpChannel {
	...
	pub fn upsert_egress_channel(&mut self, recipient: ParaId) -> &mut AbridgedHrmpChannel {

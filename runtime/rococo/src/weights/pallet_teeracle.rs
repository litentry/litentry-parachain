...
impl<T: frame_system::Config> pallet_teeracle::WeightInfo for WeightInfo<T> {
	...
	fn update_exchange_rate() -> Weight {
		// Minimum execution time: 51_964 nanoseconds.
	...
	fn update_oracle() -> Weight {
		// Minimum execution time: 50_700 nanoseconds.
		Weight::from_ref_time(59_106_000)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: Teeracle Whitelists (r:1 w:1)
	fn add_to_whitelist() -> Weight {
		// Minimum execution time: 24_839 nanoseconds.
		Weight::from_ref_time(27_485_000)

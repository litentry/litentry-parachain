...
impl<T: frame_system::Config> pallet_vc_management::WeightInfo for WeightInfo<T> {
	...
	fn request_vc() -> Weight {
		...
		Weight::from_ref_time(15_666_000)
	...
	fn revoke_vc() -> Weight {
		...
		//  Measured:  `255`
		//  Estimated: `3537`
		// Minimum execution time: 23_979 nanoseconds.
		Weight::from_ref_time(24_483_000)
			.saturating_add(Weight::from_proof_size(3537))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn some_error() -> Weight {
		...
		Weight::from_ref_time(21_307_000)
	...
	fn set_admin() -> Weight {
		...
		Weight::from_ref_time(17_439_000)
	...
	fn add_schema() -> Weight {
		...
		//  Measured:  `61`
		//  Estimated: `1030`
		// Minimum execution time: 20_688 nanoseconds.
	...
	fn revoke_schema() -> Weight {
		...
		Weight::from_ref_time(23_026_000)
			.saturating_add(Weight::from_proof_size(5623))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn add_vc_registry_item() -> Weight {
		...
		Weight::from_ref_time(21_765_000)
	...
	fn remove_vc_registry_item() -> Weight {
		...
		//  Measured:  `231`
		//  Estimated: `3314`
		// Minimum execution time: 22_484 nanoseconds.
	...
	fn clear_vc_registry(x: u32, ) -> Weight {
		...
		Weight::from_ref_time(20_717_977)
			.saturating_add(Weight::from_proof_size(527))
			// Standard Error: 2_052
			.saturating_add(Weight::from_ref_time(1_373_360).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1))

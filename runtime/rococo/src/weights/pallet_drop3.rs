...
impl<T: frame_system::Config> pallet_drop3::WeightInfo for WeightInfo<T> {
	...
	fn reject_reward_pool() -> Weight {
		Weight::from_ref_time(81_582_000 as u64)
	...
	fn close_reward_pool() -> Weight {
		Weight::from_ref_time(58_310_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: System Account (r:1 w:1)
	...
	fn propose_reward_pool(n: u32, ) -> Weight {
		Weight::from_ref_time(49_630_000 as u64)
			// Standard Error: 20_398
			.saturating_add(Weight::from_ref_time(229_359 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	...
	fn send_reward() -> Weight {
		Weight::from_ref_time(61_296_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
}

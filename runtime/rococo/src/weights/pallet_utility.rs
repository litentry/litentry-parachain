...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		(25_736_000 as Weight)
			...
			.saturating_add((6_790_000 as Weight).saturating_mul(c as Weight))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		(31_489_000 as Weight)
			// Standard Error: 2_000
			.saturating_add((7_071_000 as Weight).saturating_mul(c as Weight))
	}
	fn dispatch_as() -> Weight {
		(21_697_000 as Weight)
	}
	/// The range of component `c` is `[0, 1000]`.
	fn force_batch(c: u32, ) -> Weight {
		(29_392_000 as Weight)
			// Standard Error: 2_000
			.saturating_add((6_797_000 as Weight).saturating_mul(c as Weight))
	}
}

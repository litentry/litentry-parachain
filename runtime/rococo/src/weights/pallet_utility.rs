...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		Weight::from_ref_time(20_621_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(8_236_354 as u64).saturating_mul(c as u64))
	}
	fn as_derivative() -> Weight {
		Weight::from_ref_time(10_778_000 as u64)
	}
	/// The range of component `c` is `[0, 1000]`.
	fn batch_all(c: u32, ) -> Weight {
		Weight::from_ref_time(20_314_000 as u64)
			// Standard Error: 2_446
			.saturating_add(Weight::from_ref_time(8_482_067 as u64).saturating_mul(c as u64))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		Weight::from_ref_time(20_408_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(8_173_523 as u64).saturating_mul(c as u64))
	}
}

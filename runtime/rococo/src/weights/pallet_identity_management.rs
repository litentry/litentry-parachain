...
impl<T: frame_system::Config> pallet_identity_management::WeightInfo for WeightInfo<T> {
	fn link_identity() -> Weight {
		// Minimum execution time: 24_185 nanoseconds.
		Weight::from_ref_time(25_048_000 as u64)
	}
	fn unlink_identity() -> Weight {
		// Minimum execution time: 22_882 nanoseconds.
		Weight::from_ref_time(23_416_000 as u64)
	}
	...
	fn set_user_shielding_key() -> Weight {
		// Minimum execution time: 23_029 nanoseconds.

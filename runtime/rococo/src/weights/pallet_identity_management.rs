...
impl<T: frame_system::Config> pallet_identity_management::WeightInfo for WeightInfo<T> {
	...
	fn remove_delegatee() -> Weight {
		...
		//  Measured:  `79`
		//  Estimated: `2523`
		// Minimum execution time: 19_865 nanoseconds.
		Weight::from_ref_time(20_376_000)
	...
	fn link_identity() -> Weight {
		...
		//  Measured:  `42`
		//  Estimated: `537`
		// Minimum execution time: 19_303 nanoseconds.
		Weight::from_ref_time(19_910_000)
	...
	fn deactivate_identity() -> Weight {
		...
		//  Measured:  `42`
		//  Estimated: `537`
		// Minimum execution time: 15_932 nanoseconds.
		Weight::from_ref_time(16_453_000)
			.saturating_add(Weight::from_proof_size(537))
			.saturating_add(T::DbWeight::get().reads(1))
	}
	/// Storage: IMPExtrinsicWhitelist GroupControlOn (r:1 w:0)
	...
	fn set_user_shielding_key() -> Weight {
		...
		Weight::from_ref_time(16_553_000)
			.saturating_add(Weight::from_proof_size(537))
			.saturating_add(T::DbWeight::get().reads(1))
	}
	...
	fn user_shielding_key_set() -> Weight {
		...
		//  Measured:  `255`
		//  Estimated: `2730`
		// Minimum execution time: 20_445 nanoseconds.
		Weight::from_ref_time(20_920_000)
	...
	fn identity_linked() -> Weight {
		...
		Weight::from_ref_time(22_240_000)
			.saturating_add(Weight::from_proof_size(2730))
			.saturating_add(T::DbWeight::get().reads(1))
	}
	/// Storage: Teerex EnclaveIndex (r:1 w:0)
	...
	fn identity_deactivated() -> Weight {
		...
		Weight::from_ref_time(21_901_000)
			.saturating_add(Weight::from_proof_size(2730))
			.saturating_add(T::DbWeight::get().reads(1))
	}
	/// Storage: Teerex EnclaveIndex (r:1 w:0)
	...
	fn identity_activated() -> Weight {
		...
		Weight::from_ref_time(21_147_000)
			.saturating_add(Weight::from_proof_size(2730))
			.saturating_add(T::DbWeight::get().reads(1))
	}
	/// Storage: Teerex EnclaveIndex (r:1 w:0)
	...
	fn some_error() -> Weight {
		...
		Weight::from_ref_time(20_970_000)
			.saturating_add(Weight::from_proof_size(2730))
			.saturating_add(T::DbWeight::get().reads(1))
	}
}

...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(20_705_032)
			.saturating_add(Weight::from_proof_size(2617))
			// Standard Error: 55
			.saturating_add(Weight::from_ref_time(3_262).saturating_mul(p.into()))
			// Standard Error: 55
			.saturating_add(Weight::from_ref_time(3_751).saturating_mul(f.into()))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		// Minimum execution time: 40_487 nanoseconds.
		Weight::from_ref_time(21_112_772)
			.saturating_add(Weight::from_proof_size(2654))
			// Standard Error: 86
			.saturating_add(Weight::from_ref_time(20_188).saturating_mul(p.into()))
			// Standard Error: 86
			.saturating_add(Weight::from_ref_time(20_677).saturating_mul(f.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))

...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		Weight::from_ref_time(34_553_000 as u64)
			// Standard Error: 118
			.saturating_add(Weight::from_ref_time(3_502 as u64).saturating_mul(p as u64))
			// Standard Error: 118
			.saturating_add(Weight::from_ref_time(1_736 as u64).saturating_mul(f as u64))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		Weight::from_ref_time(50_092_000 as u64)
			// Standard Error: 622
			.saturating_add(Weight::from_ref_time(14_421 as u64).saturating_mul(p as u64))
			// Standard Error: 622
			.saturating_add(Weight::from_ref_time(5_882 as u64).saturating_mul(f as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(31_568_711 as u64)
			// Standard Error: 95
			.saturating_add(Weight::from_ref_time(3_309 as u64).saturating_mul(p as u64))
			// Standard Error: 95
			.saturating_add(Weight::from_ref_time(3_093 as u64).saturating_mul(f as u64))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(29_534_324 as u64)
			// Standard Error: 900
			.saturating_add(Weight::from_ref_time(24_567 as u64).saturating_mul(p as u64))
			// Standard Error: 900
			.saturating_add(Weight::from_ref_time(17_798 as u64).saturating_mul(f as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

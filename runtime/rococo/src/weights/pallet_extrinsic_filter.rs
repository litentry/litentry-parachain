...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(34_493_092 as u64)
			// Standard Error: 58
			.saturating_add(Weight::from_ref_time(3_682 as u64).saturating_mul(p as u64))
			// Standard Error: 58
			.saturating_add(Weight::from_ref_time(3_648 as u64).saturating_mul(f as u64))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(47_095_411 as u64)
			// Standard Error: 1_226
			.saturating_add(Weight::from_ref_time(14_916 as u64).saturating_mul(p as u64))
			// Standard Error: 1_226
			.saturating_add(Weight::from_ref_time(16_496 as u64).saturating_mul(f as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

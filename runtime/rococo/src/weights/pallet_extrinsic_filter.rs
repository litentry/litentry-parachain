...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_parts(13_403_699, 0)
			.saturating_add(Weight::from_parts(0, 3607))
			// Standard Error: 86
			.saturating_add(Weight::from_parts(2_772, 0).saturating_mul(p.into()))
			// Standard Error: 86
			.saturating_add(Weight::from_parts(2_313, 0).saturating_mul(f.into()))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_parts(14_828_975, 0)
			.saturating_add(Weight::from_parts(0, 3644))
			// Standard Error: 92
			.saturating_add(Weight::from_parts(10_321, 0).saturating_mul(p.into()))
			// Standard Error: 92
			.saturating_add(Weight::from_parts(10_231, 0).saturating_mul(f.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))

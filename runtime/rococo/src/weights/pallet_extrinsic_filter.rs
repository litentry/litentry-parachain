...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(26_913_392)
			// Standard Error: 58
			.saturating_add(Weight::from_ref_time(3_911).saturating_mul(p.into()))
			// Standard Error: 58
			.saturating_add(Weight::from_ref_time(4_097).saturating_mul(f.into()))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		// Minimum execution time: 45_069 nanoseconds.
		Weight::from_ref_time(29_366_888)
			// Standard Error: 65
			.saturating_add(Weight::from_ref_time(16_886).saturating_mul(p.into()))
			// Standard Error: 65
			.saturating_add(Weight::from_ref_time(17_244).saturating_mul(f.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		Weight::from_ref_time(35_697_000 as u64)
			// Standard Error: 63
			.saturating_add(Weight::from_ref_time(2_303 as u64).saturating_mul(p as u64))
			// Standard Error: 63
			.saturating_add(Weight::from_ref_time(2_319 as u64).saturating_mul(f as u64))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		Weight::from_ref_time(51_540_000 as u64)
			// Standard Error: 174
			.saturating_add(Weight::from_ref_time(6_344 as u64).saturating_mul(p as u64))
			// Standard Error: 174
			.saturating_add(Weight::from_ref_time(7_106 as u64).saturating_mul(f as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

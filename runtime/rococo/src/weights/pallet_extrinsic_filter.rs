...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_ref_time(20_427_017)
			.saturating_add(Weight::from_proof_size(2617))
			// Standard Error: 94
			.saturating_add(Weight::from_ref_time(4_159).saturating_mul(p.into()))
			// Standard Error: 94
			.saturating_add(Weight::from_ref_time(4_126).saturating_mul(f.into()))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		// Minimum execution time: 41_216 nanoseconds.
		Weight::from_ref_time(22_554_795)
			.saturating_add(Weight::from_proof_size(2654))
			// Standard Error: 122
			.saturating_add(Weight::from_ref_time(20_025).saturating_mul(p.into()))
			// Standard Error: 122
			.saturating_add(Weight::from_ref_time(20_179).saturating_mul(f.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))

...
impl<T: frame_system::Config> pallet_teerex::WeightInfo for WeightInfo<T> {
	...
	fn register_enclave() -> Weight {
		...
		//  Measured:  `451`
		//  Estimated: `10227`
		// Minimum execution time: 2_031_907 nanoseconds.
		Weight::from_ref_time(2_056_976_000)
	...
	fn unregister_enclave() -> Weight {
		...
		Weight::from_ref_time(43_197_000)
	...
	fn call_worker() -> Weight {
		...
		Weight::from_ref_time(14_854_000)
	...
	fn confirm_processed_parentchain_block() -> Weight {
		...
		Weight::from_ref_time(39_209_000)
	...
	fn publish_hash(l: u32, t: u32, ) -> Weight {
		...
		Weight::from_ref_time(31_118_914)
			.saturating_add(Weight::from_proof_size(8568))
			// Standard Error: 493
			.saturating_add(Weight::from_ref_time(1_577).saturating_mul(l.into()))
			// Standard Error: 11_023
			.saturating_add(Weight::from_ref_time(2_795_695).saturating_mul(t.into()))
			.saturating_add(T::DbWeight::get().reads(3))

...
impl<T: frame_system::Config> pallet_teerex::WeightInfo for WeightInfo<T> {
	...
	fn register_enclave() -> Weight {
		...
		//  Measured:  `451`
		//  Estimated: `10227`
		// Minimum execution time: 1_926_846 nanoseconds.
		Weight::from_ref_time(1_947_704_000)
	...
	fn unregister_enclave() -> Weight {
		...
		//  Measured:  `523`
		//  Estimated: `7014`
		// Minimum execution time: 43_506 nanoseconds.
		Weight::from_ref_time(52_072_000)
	...
	fn call_worker() -> Weight {
		...
		Weight::from_ref_time(16_187_000)
	...
	fn confirm_processed_parentchain_block() -> Weight {
		...
		//  Measured:  `423`
		//  Estimated: `6299`
		// Minimum execution time: 39_661 nanoseconds.
	...
	fn publish_hash(l: u32, t: u32, ) -> Weight {
		...
		Weight::from_ref_time(35_241_598)
			.saturating_add(Weight::from_proof_size(8568))
			// Standard Error: 5_124
			.saturating_add(Weight::from_ref_time(2_104).saturating_mul(l.into()))
			// Standard Error: 114_357
			.saturating_add(Weight::from_ref_time(3_094_645).saturating_mul(t.into()))
			.saturating_add(T::DbWeight::get().reads(3))

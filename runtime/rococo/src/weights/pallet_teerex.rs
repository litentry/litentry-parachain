...
impl<T: frame_system::Config> pallet_teerex::WeightInfo for WeightInfo<T> {
	...
	fn register_enclave() -> Weight {
		...
		//  Measured:  `451`
		//  Estimated: `6391`
		// Minimum execution time: 2_128_998_000 picoseconds.
		Weight::from_parts(2_158_731_000, 0)
	...
	fn unregister_enclave() -> Weight {
		...
		Weight::from_parts(42_354_000, 0)
	...
	fn publish_hash(l: u32, t: u32, ) -> Weight {
		...
		Weight::from_parts(30_958_566, 0)
			.saturating_add(Weight::from_parts(0, 3814))
			// Standard Error: 344
			.saturating_add(Weight::from_parts(1_032, 0).saturating_mul(l.into()))
			// Standard Error: 7_687
			.saturating_add(Weight::from_parts(2_673_579, 0).saturating_mul(t.into()))
			.saturating_add(T::DbWeight::get().reads(3))

...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for WeightInfo<T> {
	...
	fn register_foreign_asset_type() -> Weight {
		...
		//  Measured:  `142`
		//  Estimated: `3538`
		// Minimum execution time: 34_956 nanoseconds.
		Weight::from_ref_time(35_510_000)
	...
	fn update_foreign_asset_metadata() -> Weight {
		...
		Weight::from_ref_time(21_525_000)
	...
	fn add_asset_type() -> Weight {
		...
		//  Measured:  `325`
		//  Estimated: `5600`
		// Minimum execution time: 25_587 nanoseconds.
	...
	fn remove_asset_type() -> Weight {
		...
		Weight::from_ref_time(33_069_000)

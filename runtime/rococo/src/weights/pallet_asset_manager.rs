...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for WeightInfo<T> {
	...
	fn register_foreign_asset_type() -> Weight {
		// Minimum execution time: 48_976 nanoseconds.
		Weight::from_ref_time(50_266_000 as u64)
	...
	fn add_asset_type() -> Weight {
		// Minimum execution time: 38_128 nanoseconds.
		Weight::from_ref_time(39_236_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	...
	fn remove_asset_type() -> Weight {
		...
		Weight::from_ref_time(48_537_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
}

...
impl pallet_teerex::Config for Runtime {
	...
	type WeightInfo = weight::pallet_teerex::WeightInfo<Runtime>;
}

impl pallet_sidechain::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
	type WeightInfo = weight::pallet_sidechain::WeightInfo<Runtime>;
	type EarlyBlockProposalLenience = ConstU64<100>;
}

impl pallet_teeracle::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
	type WeightInfo = weight::pallet_teeracle::WeightInfo<Runtime>;

...
#[test]
fn test_keccak256() {
	assert_eq!(&precompile_utils_macro_v2::keccak256!(""), keccak_256(b"").as_slice(),);
	assert_eq!(&precompile_utils_macro_v2::keccak256!("toto()"), keccak_256(b"toto()").as_slice(),);
	assert_ne!(&precompile_utils_macro_v2::keccak256!("toto()"), keccak_256(b"tata()").as_slice(),);
}
